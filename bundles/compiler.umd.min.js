...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function kp(e){var t=e.charCodeAt(0);if(t==e.charCodeAt(e.length-1)&&(39==t||34==t)){var n=e.substring(1,e.length-1);-1==n.indexOf("'")&&-1==n.indexOf('"')&&(e=n)}return e}function Op(e){return e.replace(/[a-z][A-Z]/g,function(e){return e.charAt(0)+"-"+e.charAt(1)}).toLowerCase()}
/**
    * @license
    * Copyright Google Inc. All Rights Reserved.
    *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var oc=[],sc=/attr\.([^\]]+)/;function ac(e,t,n){var r=new Ei;r.set("type",e.type),r.set("selectors",function i(e){return di(ee(e))}(e.selector));var o=xi({name:e.name,type:e.type,deps:e.deps,injectFn:Bn.directiveInject});return r.set("factory",o.factory),e.queries.length>0&&r.set("contentQueries",mc(e.queries,t,e.name)),e.viewQueries.length&&r.set("viewQuery",Ec(e.viewQueries,t,e.name)),r.set("hostBindings",Sc(e.host,e.typeSourceSpan,n,t,e.selector||"",e.name)),r.set("inputs",vi(e.inputs,!0)),r.set("outputs",vi(e.outputs)),null!==e.exportAs&&r.set("exportAs",St(e.exportAs.map(function(e){return bt(e)}))),{definitionMap:r,statements:o.statements}}function uc(e,t){var n=[],r=t.providers,i=t.viewProviders;if(r||i){var o=[r||new He([])];i&&o.push(i),n.push(gt(Bn.ProvidersFeature).callFn(o))}t.usesInheritance&&n.push(gt(Bn.InheritDefinitionFeature)),t.lifecycle.usesOnChanges&&n.push(gt(Bn.NgOnChangesFeature).callFn(oc)),n.length&&e.set("features",St(n))}function pc(e,t,n){var r=ac(e,t,n),i=r.definitionMap,o=r.statements;uc(i,e);var s=gt(Bn.defineDirective).callFn([i.toLiteralMap()]);if(!e.selector)throw new Error("Directive "+e.name+" has no selector, please add it!");return{expression:s,type:_c(e,Bn.DirectiveDefWithMeta),statements:o}}function lc(e,t,n){var r=new Ei;if(e.inputs){var i=e.inputs,o=Object.keys(i).map(function(e){var t=i[e];return{key:e,value:Array.isArray(t)?St(t.map(function(e){return bt(e)})):bt(t),quoted:!1}});r.set("inputs",xt(o))}if(e.outputs){var s=e.outputs,a=Object.keys(s).map(function(e){return{key:e,value:bt(s[e]),quoted:!1}});r.set("outputs",xt(a))}return e.viewQueries&&e.viewQueries.length>0&&r.set("viewQuery",Ec(e.viewQueries,t)),e.queries&&e.queries.length>0&&r.set("contentQueries",mc(e.queries,t)),e.host&&r.set("hostBindings",Sc(e.host,e.typeSourceSpan,n,t,e.name)),{expression:gt(Bn.defineBase).callFn([r.toLiteralMap()]),type:new ae(gt(Bn.BaseDef))}}function cc(e,t,n){var r,i,s=ac(e,t,n),a=s.definitionMap,u=s.statements;uc(a,e);var p=e.selector&&w.parse(e.selector),l=p&&p[0];if(l){var c=l.getAttrs();c.length&&a.set("attrs",t.getConstLiteral(St(c.map(function(e){return bt(null!=e?e:void 0)})),!0))}var h=null;if(e.directives.length>0){var f=new C;try{for(var d=o(e.directives),v=d.next();!v.done;v=d.next()){var m=v.value,y=m.expression;f.addSelectables(w.parse(m.selector),y)}}catch(e){r={error:e}}finally{try{v&&!v.done&&(i=d.return)&&i.call(d)}finally{if(r)throw r.error}}h=f}var g=e.name,_=g?g+"_Template":null,x=new Set,b=new Set,T=e.changeDetection,N=e.template,P=new Hl(t,$l.ROOT_SCOPE,0,g,null,null,_,h,x,e.pipes,b,Bn.namespaceHTML,e.relativeContextFilePath,e.i18nUseExternalIds),M=P.buildTemplateFunction(N.nodes,[]),A=P.getNgContentSelectors();if(A&&a.set("ngContentSelectors",A),a.set("consts",bt(P.getConstCount())),a.set("vars",bt(P.getVarCount())),a.set("template",M),x.size){var I=St(Array.from(x));e.wrapDirectivesAndPipesInClosure&&(I=wt([],[new Je(I)])),a.set("directives",I)}if(b.size){var k=St(Array.from(b));e.wrapDirectivesAndPipesInClosure&&(k=wt([],[new Je(k)])),a.set("pipes",k)}if(null===e.encapsulation&&(e.encapsulation=E.Emulated),e.styles&&e.styles.length){var O=(e.encapsulation==E.Emulated?function R(e,t,n){var r=new Ys;return e.map(function(e){return r.shimCssText(e,t,n)})}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e.styles,ba,Ca):e.styles).map(function(e){return bt(e)});a.set("styles",St(O))}else e.encapsulation===E.Emulated&&(e.encapsulation=E.None);return e.encapsulation!==E.Emulated&&a.set("encapsulation",bt(e.encapsulation)),null!==e.animations&&a.set("data",xt([{key:"animation",value:e.animations,quoted:!1}])),null!=T&&T!==S.Default&&a.set("changeDetection",bt(T)),(e.selector||"").replace(/\n/g,""),{expression:gt(Bn.defineComponent).callFn([a.toLiteralMap()]),type:_c(e,Bn.ComponentDefWithMeta),statements:u}}function hc(e,t,n){throw new Error("unsupported")}function fc(e,t){return e.map(function(e){var n=null;return e.read&&e.read.identifier&&(n=t.importExpr(e.read.identifier.reference)),{propertyName:e.propertyName,first:e.first,predicate:dc(e.selectors,t),descendants:e.descendants,read:n,static:!!e.static}})}function dc(e,t){if(e.length>1||1==e.length&&e[0].value){var n=e.map(function(e){return e.value});return n.some(function(e){return!e})&&Lt("Found a type among the string selectors expected"),t.constantPool.getConstLiteral(St(n.map(function(e){return bt(e)})))}if(1==e.length){var r=e[0];if(r.identifier)return t.importExpr(r.identifier.reference)}return Lt("Unexpected query form"),Ke}function vc(e,t){return[yi(e,t),bt(e.descendants),e.read||bt(null)]}function mc(e,t,n){var r,i,s=[],u=[],p=ci(u,ui);try{for(var l=o(e),c=l.next();!c.done;c=l.next()){var h=c.value,f=a([yt("dirIndex")],vc(h,t));s.push(gt(h.static?Bn.staticContentQuery:Bn.contentQuery).callFn(f).toStmt());var d=p(),v=gt(Bn.loadContentQuery).callFn([]),m=gt(Bn.queryRefresh).callFn([d.set(v)]),y=yt(pi).prop(h.propertyName).set(h.first?d.prop("first"):d);u.push(m.and(y).toStmt())}}catch(e){r={error:e}}finally{try{c&&!c.done&&(i=l.return)&&i.call(l)}finally{if(r)throw r.error}}var g=n?n+"_ContentQueries":null;return wt([new Le(li,fe),new Le(pi,null),new Le("dirIndex",null)],[jl(1,s),jl(2,u)],ce,null,g)}function yc(e){return Et(xt(Object.keys(e).map(function(t){return{key:t,value:bt(Array.isArray(e[t])?e[t][0]:e[t]),quoted:!0}})))}function gc(e){return e.length>0?Et(St(e.map(function(e){return bt(e)}))):de}function _c(e,t){var n,r=(e.selector||"").replace(/\n/g,"");return Et(gt(t,[Mi(e.type,e.typeArgumentCount),(n=r,Et(bt(n))),null!==e.exportAs?gc(e.exportAs):de,yc(e.inputs),yc(e.outputs),gc(e.queries.map(function(e){return e.propertyName}))]))}function Ec(e,t,n){var r=[],i=[],o=ci(i,ui);e.forEach(function(e){var n=gt(e.static?Bn.staticViewQuery:Bn.viewQuery).callFn(vc(e,t));r.push(n.toStmt());var s=o(),a=gt(Bn.loadViewQuery).callFn([]),u=gt(Bn.queryRefresh).callFn([s.set(a)]),p=yt(pi).prop(e.propertyName).set(e.first?s.prop("first"):s);i.push(u.and(p).toStmt())});var s=n?n+"_Query":null;return wt([new Le(li,fe),new Le(pi,null)],[jl(1,r),jl(2,i)],ce,null,s)}function Sc(e,t,n,r,i,s){var u=Object.keys(e.properties).filter(function(e){var t=function n(e){return e.substring(0,5)}(e);return"style"!==t&&"class"!==t}).length,p=yt("elIndex"),l=yt(pi),c=new Dp(p,l),h=e.specialAttributes,f=h.styleAttr,d=h.classAttr;void 0!==f&&c.registerStyleAttr(f),void 0!==d&&c.registerClassAttr(d);var v,m=[],y=[],g=u,_=t,E=Cc(e),S=function(){return v||(v=new ql(r,function(){return Lt("Unexpected node")},function(e){var t=g;return g+=e,t},function(){return Lt("Unexpected pipe")})),v},x=n.createDirectiveHostEventAsts(E,_);if(x&&x.length){var w=function C(e,t,n){return t.map(function(t){var r=t.name&&cn(t.name),i=1===t.type?ki(r,t.targetOrPhase):r,o=n&&r?n+"_"+i+"_HostBindingHandler":null,s=Ul(qn.fromParsedEvent(t),e,o);return gt(1==t.type?Bn.componentHostSyntheticListener:Bn.listener).callFn(s).toStmt()})}(l,x,s);m.push.apply(m,a(w))}(n.createBoundHostProperties(E,_)||[]).forEach(function(e){if(!c.registerInputBasedOnName(e.name,e.expression,e.sourceSpan)){var t=e.expression.visit(S()),r=xc(l,t),o=function s(e){var t,n=e.name,r=n.match(sc);return r?(n=r[1],t=Bn.attribute):e.isAnimation?(n=Ii(n),t=Bn.componentHostSyntheticProperty):t=Bn.property,{bindingName:n,instruction:t,isAttribute:!!r}}(e),u=o.bindingName,h=o.instruction,f=o.isAttribute,d=n.calcPossibleSecurityContexts(i,u,f).filter(function(e){return e!==D.NONE}),v=null;d.length&&(v=2===d.length&&d.indexOf(D.URL)>-1&&d.indexOf(D.RESOURCE_URL)>-1?gt(Bn.sanitizeUrlOrResourceUrl):nc(d[0],f));var m=h===Bn.property||h===Bn.attribute?[bt(u),r.currValExpr]:[p,bt(u),gt(Bn.bind).callFn([r.currValExpr])];v&&m.push(v),f||(v||m.push(bt(null)),m.push(bt(!0))),y.push.apply(y,a(r.stmts)),y.push(gt(h).callFn(m).toStmt())}});var b=function T(e){var t,n,r=[];try{for(var i=o(Object.getOwnPropertyNames(e)),s=i.next();!s.done;s=i.next()){var a=s.value,u=e[a];r.push(bt(a),u)}}catch(e){t={error:e}}finally{try{s&&!s.done&&(n=i.return)&&n.call(i)}finally{if(t)throw t.error}}return r}(e.attributes),N=c.buildHostAttrsInstruction(null,b,r);if(N&&m.push(wc(N,l,xc)),c.hasBindings){var P=c.buildStylingInstruction(null,r);P&&m.push(wc(P,l,xc)),c.buildUpdateLevelInstructions(S()).forEach(function(e){g+=e.allocateBindingSlots,y.push(wc(e,l,xc))})}if(g&&m.unshift(gt(Bn.allocHostVars).callFn([bt(g)]).toStmt()),m.length>0||y.length>0){var M=s?s+"_HostBindings":null,A=[];return m.length>0&&A.push(jl(1,m)),y.length>0&&A.push(jl(2,y)),wt([new Le(li,fe),new Le(pi,null),new Le(p.name,fe)],A,ce,null,M)}return null}function xc(e,t){return Us(null,e,t,"b",Bs.TrySimple,function(){return Lt("Unexpected interpolation")})}function wc(e,t,n){var r=e.buildParams(function(e){return n(t,e).currValExpr});return gt(e.reference,null,e.sourceSpan).callFn(r,e.sourceSpan).toStmt()}function Cc(e){return{hostAttributes:{},hostListeners:e.listeners,hostProperties:e.properties}}function bc(e,t){var n=Array.from(e).map(function(e){var n=s(e,2);return[n[0],t.importExpr(n[1])]});return new Map(n)}var Tc=/^(?:\[([^\]]+)\])|(?:\(([^\)]+)\))$/;function Nc(e){var t,n,r={},i={},s={},a={};try{for(var u=o(Object.keys(e)),p=u.next();!p.done;p=u.next()){var l=p.value,c=e[l],h=l.match(Tc);if(null===h)switch(l){case"class":if("string"!=typeof c)throw new Error("Class binding must be string");a.classAttr=c;break;case"style":if("string"!=typeof c)throw new Error("Style binding must be string");a.styleAttr=c;break;default:r[l]="string"==typeof c?bt(c):c}else if(null!=h[1]){if("string"!=typeof c)throw new Error("Property binding must be string");s[h[1]]=c}else if(null!=h[2]){if("string"!=typeof c)throw new Error("Event binding must be string");i[h[2]]=c}}}catch(e){t={error:e}}finally{try{p&&!p.done&&(n=u.return)&&n.call(u)}finally{if(t)throw t.error}}return{attributes:r,listeners:i,properties:s,specialAttributes:a}}function Pc(e,t){var n=Cc(e),r=tc();return r.createDirectiveHostEventAsts(n,t),r.createBoundHostProperties(n,t),r.errors}var Mc=function(){function e(){}return e.prototype.get=function(e){return""},e}(),Ac=function(){function t(t){void 0===t&&(t=new eo),this.jitEvaluator=t,this.R3ResolvedDependencyType=e.R3ResolvedDependencyType,this.ResourceLoader=Mc,this.elementSchemaRegistry=new vl}return t.prototype.compilePipe=function(e,t,n){var r=Jo({name:n.name,type:new xe(n.type),typeArgumentCount:n.typeArgumentCount,deps:jc(n.deps),pipeName:n.pipeName,pure:n.pure});return this.jitExpression(r.expression,e,t,r.statements)},t.prototype.compileInjectable=function(e,t,n){var r,i=Oi({name:n.name,type:new xe(n.type),typeArgumentCount:n.typeArgumentCount,providedIn:(r=n.providedIn,null==r||"string"==typeof r?new Ae(r):new xe(r)),useClass:Bc(n,Ic),useFactory:Bc(n,kc),useValue:Bc(n,Oc),useExisting:Bc(n,Rc),ctorDeps:jc(n.ctorDeps),userDeps:jc(n.userDeps)||void 0});return this.jitExpression(i.expression,e,t,i.statements)},t.prototype.compileInjector=function(e,t,n){var r=Go({name:n.name,type:new xe(n.type),deps:jc(n.deps),providers:new xe(n.providers),imports:n.imports.map(function(e){return new xe(e)})});return this.jitExpression(r.expression,e,t,r.statements)},t.prototype.compileNgModule=function(e,t,n){var r=Xo({type:new xe(n.type),bootstrap:n.bootstrap.map(Dc),declarations:n.declarations.map(Dc),imports:n.imports.map(Dc),exports:n.exports.map(Dc),emitInline:!0,containsForwardDecls:!1,schemas:n.schemas?n.schemas.map(Dc):null,id:n.id?new xe(n.id):null});return this.jitExpression(r.expression,e,t,[])},t.prototype.compileDirective=function(e,t,n){var r=new Zt,i=tc(),o=pc(Lc(n),r,i),s=a(r.statements,o.statements);return this.jitExpression(o.expression,e,t,s)},t.prototype.compileComponent=function(e,t,n){var r=new Zt,o=n.interpolation?Li.fromArray(n.interpolation):Bi,s=ec(n.template,t,{preserveWhitespaces:n.preserveWhitespaces,interpolationConfig:o});if(void 0!==s.errors){var u=s.errors.map(function(e){return e.toString()}).join(", ");throw new Error("Errors during JIT compilation of template for "+n.name+": "+u)}var p=cc(i({},n,Lc(n),{selector:n.selector||this.elementSchemaRegistry.getDefaultComponentElementName(),template:s,wrapDirectivesAndPipesInClosure:!1,styles:n.styles||[],encapsulation:n.encapsulation,interpolation:o,changeDetection:n.changeDetection,animations:null!=n.animations?new xe(n.animations):null,viewProviders:null!=n.viewProviders?new xe(n.viewProviders):null,relativeContextFilePath:"",i18nUseExternalIds:!0}),r,tc(o)),l=a(r.statements,p.statements);return this.jitExpression(p.expression,e,"ng:///"+n.name+".js",l)},t.prototype.compileBase=function(e,t,n){var r=new Zt,o=this.createParseSourceSpan("Base",n.name,"ng:///"+n.name+".js"),s=lc(i({},n,{typeSourceSpan:o,viewQueries:n.viewQueries?n.viewQueries.map(Fc):n.viewQueries,queries:n.queries?n.queries.map(Fc):n.queries,host:Uc(n.propMetadata,o)}),r,tc());return this.jitExpression(s.expression,e,t,r.statements)},t.prototype.createParseSourceSpan=function(e,t,n){return Ko(e,t,n)},t.prototype.jitExpression=function(t,n,r,i){var o=a(i,[new Ge("$def",t,void 0,[e.StmtModifier.Exported])]);return this.jitEvaluator.evaluateStatements(r,o,new Qo(n),!0).$def},t}(),Ic=Object.keys({useClass:null})[0],kc=Object.keys({useFactory:null})[0],Oc=Object.keys({useValue:null})[0],Rc=Object.keys({useExisting:null})[0],Dc=function(e){var t=new xe(e);return{value:t,type:t}};
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Fc(e){return i({},e,{predicate:Array.isArray(e.predicate)?e.predicate:new xe(e.predicate),read:e.read?new xe(e.read):null,static:e.static})}function Lc(e){var t=Hc(e.inputs||[]),n=Hc(e.outputs||[]),r=e.propMetadata,o={},s={},a=function(e){r.hasOwnProperty(e)&&r[e].forEach(function(t){!function n(e){return"Input"===e.ngMetadataName}(t)?function r(e){return"Output"===e.ngMetadataName}(t)&&(s[e]=t.bindingPropertyName||e):o[e]=t.bindingPropertyName?[t.bindingPropertyName,e]:e})};for(var u in r)a(u);return i({},e,{typeSourceSpan:e.typeSourceSpan,type:new xe(e.type),deps:jc(e.deps),host:Uc(e.propMetadata,e.typeSourceSpan,e.host),inputs:i({},t,o),outputs:i({},n,s),queries:e.queries.map(Fc),providers:null!=e.providers?new xe(e.providers):null,viewQueries:e.viewQueries.map(Fc)})}function Bc(e,t){return e.hasOwnProperty(t)?new xe(e[t]):void 0}function Vc(t){return{token:null===t.token?new Ae(null):t.resolved===e.R3ResolvedDependencyType.Attribute?new Ae(t.token):new xe(t.token),resolved:t.resolved,host:t.host,optional:t.optional,self:t.self,skipSelf:t.skipSelf}}function jc(e){return null==e?null:e.map(Vc)}function Uc(e,t,n){var r=Nc(n||{}),i=Pc(r,t);if(i.length)throw new Error(i.map(function(e){return e.msg}).join("\n"));var o=function(t){e.hasOwnProperty(t)&&e[t].forEach(function(e){!function n(e){return"HostBinding"===e.ngMetadataName}(e)?function i(e){return"HostListener"===e.ngMetadataName}(e)&&(r.listeners[e.eventName||t]=t+"("+(e.args||[]).join(",")+")"):r.properties[e.hostPropertyName||t]=t})};for(var s in e)o(s);return r}function Hc(e){return e.reduce(function(e,t){var n=s(t.split(",").map(function(e){return e.trim()}),2),r=n[0];return e[r]=n[1]||r,e},{})}function qc(e){(e.ng||(e.ng={})).ɵcompilerFacade=new Ac}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Wc=new Qt("8.0.0-rc.0+320.sha-21e8ac1.with-local-changes"),zc=function zc(e){var t=void 0===e?{}:e,n=t.defaultEncapsulation,r=t.useJit,i=void 0===r||r,o=t.jitDevMode,s=void 0!==o&&o,a=t.missingTranslation,u=void 0===a?null:a,p=t.preserveWhitespaces,l=t.strictInjectionParameters;this.defaultEncapsulation=void 0===n?E.Emulated:n,this.useJit=!!i,this.jitDevMode=!!s,this.missingTranslation=u,this.preserveWhitespaces=Kc(kt(p)),this.strictInjectionParameters=!0===l};
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Zc,eh=function(e){function t(t,n){return e.call(this,t,n)||this}return n(t,e),t}(Wo),th=/^i18n:?/,nh="|",rh="@@",ih=!1,oh=function oh(e,t){this.messages=e,this.errors=t};
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var lh=function(e){function t(){return e.call(this,ph)||this}return n(t,e),t.prototype.parse=function(t,n,r){return e.prototype.parse.call(this,t,n,r)},t}(iu),ch=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return n(t,e),t.prototype.write=function(e,t){var n=new hh,r=[];e.forEach(function(e){var t,i=[];e.sources.forEach(function(e){var t=new Ir("context-group",{purpose:"location"});t.children.push(new Or(10),new Ir("context",{"context-type":"sourcefile"},[new kr(e.filePath)]),new Or(10),new Ir("context",{"context-type":"linenumber"},[new kr(""+e.startLine)]),new Or(8)),i.push(new Or(8),t)});var o=new Ir("trans-unit",{id:e.id,datatype:"html"});(t=o.children).push.apply(t,a([new Or(8),new Ir("source",{},n.serialize(e.nodes))],i)),e.description&&o.children.push(new Or(8),new Ir("note",{priority:"1",from:"description"},[new kr(e.description)])),e.meaning&&o.children.push(new Or(8),new Ir("note",{priority:"1",from:"meaning"},[new kr(e.meaning)])),o.children.push(new Or(6)),r.push(new Or(6),o)});var i=new Ir("body",{},a(r,[new Or(4)])),o=new Ir("file",{"source-language":t||"en",datatype:"plaintext",original:"ng2.template"},[new Or(4),i,new Or(2)]),s=new Ir("xliff",{version:"1.2",xmlns:"urn:oasis:names:tc:xliff:document:1.2"},[new Or(2),o,new Or]);return Pr([new Mr({version:"1.0",encoding:"UTF-8"}),new Or,s,new Or])},t.prototype.load=function(e,t){var n=(new fh).parse(e,t),r=n.locale,i=n.msgIdToHtml,o=n.errors,s={},u=new dh;if(Object.keys(i).forEach(function(e){var n=u.convert(i[e],t),r=n.i18nNodes;o.push.apply(o,a(n.errors)),s[e]=r}),o.length)throw new Error("xliff parse errors:\n"+o.join("\n"));return{locale:r,i18nNodesByMsgId:s}},t.prototype.digest=function(e){return sr(e)},t}(br),hh=function(){function e(){}return e.prototype.visitText=function(e,t){return[new kr(e.value)]},e.prototype.visitContainer=function(e,t){var n=this,r=[];return e.children.forEach(function(e){return r.push.apply(r,a(e.visit(n)))}),r},e.prototype.visitIcu=function(e,t){var n=this,r=[new kr("{"+e.expressionPlaceholder+", "+e.type+", ")];return Object.keys(e.cases).forEach(function(t){r.push.apply(r,a([new kr(t+" {")],e.cases[t].visit(n),[new kr("} ")]))}),r.push(new kr("}")),r},e.prototype.visitTagPlaceholder=function(e,t){var n=function r(e){switch(e.toLowerCase()){case"br":return"lb";case"img":return"image";default:return"x-"+e}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e.tag);if(e.isVoid)return[new Ir("x",{id:e.startName,ctype:n,"equiv-text":"<"+e.tag+"/>"})];var i=new Ir("x",{id:e.startName,ctype:n,"equiv-text":"<"+e.tag+">"}),o=new Ir("x",{id:e.closeName,ctype:n,"equiv-text":"</"+e.tag+">"});return a([i],this.serialize(e.children),[o])},e.prototype.visitPlaceholder=function(e,t){return[new Ir("x",{id:e.name,"equiv-text":"{{"+e.value+"}}"})]},e.prototype.visitIcuPlaceholder=function(e,t){var n="{"+e.value.expression+", "+e.value.type+", "+Object.keys(e.value.cases).map(function(e){return e+" {...}"}).join(" ")+"}";return[new Ir("x",{id:e.name,"equiv-text":n})]},e.prototype.serialize=function(e){var t=this;return[].concat.apply([],a(e.map(function(e){return e.visit(t)})))},e}(),fh=function(){function e(){this._locale=null}return e.prototype.parse=function(e,t){this._unitMlString=null,this._msgIdToHtml={};var n=(new lh).parse(e,t);return this._errors=n.errors,La(this,n.rootNodes,null),{msgIdToHtml:this._msgIdToHtml,errors:this._errors,locale:this._locale}},e.prototype.visitElement=function(e,t){switch(e.name){case"trans-unit":this._unitMlString=null;var n=e.attrs.find(function(e){return"id"===e.name});if(n){var r=n.value;this._msgIdToHtml.hasOwnProperty(r)?this._addError(e,"Duplicated translations for msg "+r):(La(this,e.children,null),"string"==typeof this._unitMlString?this._msgIdToHtml[r]=this._unitMlString:this._addError(e,"Message "+r+" misses a translation"))}else this._addError(e,'<trans-unit> misses the "id" attribute');break;case"source":case"seg-source":break;case"target":var i=e.startSourceSpan.start.file.content.slice(e.startSourceSpan.end.offset,e.endSourceSpan.start.offset);this._unitMlString=i;break;case"file":var o=e.attrs.find(function(e){return"target-language"===e.name});o&&(this._locale=o.value),La(this,e.children,null);break;default:La(this,e.children,null)}},e.prototype.visitAttribute=function(e,t){},e.prototype.visitText=function(e,t){},e.prototype.visitComment=function(e,t){},e.prototype.visitExpansion=function(e,t){},e.prototype.visitExpansionCase=function(e,t){},e.prototype._addError=function(e,t){this._errors.push(new eh(e.sourceSpan,t))},e}(),dh=function(){function e(){}return e.prototype.convert=function(e,t){var n=(new lh).parse(e,t,{tokenizeExpansionForms:!0});return this._errors=n.errors,{i18nNodes:this._errors.length>0||0==n.rootNodes.length?[]:[].concat.apply([],a(La(this,n.rootNodes))),errors:this._errors}},e.prototype.visitText=function(e,t){return new Jn(e.value,e.sourceSpan)},e.prototype.visitElement=function(e,t){if("x"===e.name){var n=e.attrs.find(function(e){return"id"===e.name});return n?new nr("",n.value,e.sourceSpan):(this._addError(e,'<x> misses the "id" attribute'),null)}return"mrk"===e.name?[].concat.apply([],a(La(this,e.children))):(this._addError(e,"Unexpected tag"),null)},e.prototype.visitExpansion=function(e,t){var n={};return La(this,e.cases).forEach(function(t){n[t.value]=new Zn(t.nodes,e.sourceSpan)}),new er(e.switchValue,e.type,n,e.sourceSpan)},e.prototype.visitExpansionCase=function(e,t){return{value:e.value,nodes:La(this,e.expression)}},e.prototype.visitComment=function(e,t){},e.prototype.visitAttribute=function(e,t){},e.prototype._addError=function(e,t){this._errors.push(new eh(e.sourceSpan,t))},e}(),vh=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return n(t,e),t.prototype.write=function(e,t){var n=new mh,r=[];e.forEach(function(e){var t=new Ir("unit",{id:e.id}),i=new Ir("notes");(e.description||e.meaning)&&(e.description&&i.children.push(new Or(8),new Ir("note",{category:"description"},[new kr(e.description)])),e.meaning&&i.children.push(new Or(8),new Ir("note",{category:"meaning"},[new kr(e.meaning)]))),e.sources.forEach(function(e){i.children.push(new Or(8),new Ir("note",{category:"location"},[new kr(e.filePath+":"+e.startLine+(e.endLine!==e.startLine?","+e.endLine:""))]))}),i.children.push(new Or(6)),t.children.push(new Or(6),i);var o=new Ir("segment");o.children.push(new Or(8),new Ir("source",{},n.serialize(e.nodes)),new Or(6)),t.children.push(new Or(6),o,new Or(4)),r.push(new Or(4),t)});var i=new Ir("file",{original:"ng.template",id:"ngi18n"},a(r,[new Or(2)])),o=new Ir("xliff",{version:"2.0",xmlns:"urn:oasis:names:tc:xliff:document:2.0",srcLang:t||"en"},[new Or(2),i,new Or]);return Pr([new Mr({version:"1.0",encoding:"UTF-8"}),new Or,o,new Or])},t.prototype.load=function(e,t){var n=(new yh).parse(e,t),r=n.locale,i=n.msgIdToHtml,o=n.errors,s={},u=new gh;if(Object.keys(i).forEach(function(e){var n=u.convert(i[e],t),r=n.i18nNodes;o.push.apply(o,a(n.errors)),s[e]=r}),o.length)throw new Error("xliff2 parse errors:\n"+o.join("\n"));return{locale:r,i18nNodesByMsgId:s}},t.prototype.digest=function(e){return ar(e)},t}(br),mh=function(){function e(){}return e.prototype.visitText=function(e,t){return[new kr(e.value)]},e.prototype.visitContainer=function(e,t){var n=this,r=[];return e.children.forEach(function(e){return r.push.apply(r,a(e.visit(n)))}),r},e.prototype.visitIcu=function(e,t){var n=this,r=[new kr("{"+e.expressionPlaceholder+", "+e.type+", ")];return Object.keys(e.cases).forEach(function(t){r.push.apply(r,a([new kr(t+" {")],e.cases[t].visit(n),[new kr("} ")]))}),r.push(new kr("}")),r},e.prototype.visitTagPlaceholder=function(e,t){var n=this,r=function i(e){switch(e.toLowerCase()){case"br":case"b":case"i":case"u":return"fmt";case"img":return"image";case"a":return"link";default:return"other"}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(n);this._translationBundle=xh.load(t,"i18n",o,r,i)}else this._translationBundle=new xh({},null,sr,void 0,r,i)}return e.prototype.parse=function(e,t,n){void 0===n&&(n={});var r=n.interpolationConfig||Bi,o=this._htmlParser.parse(e,t,i({interpolationConfig:r},n));return o.errors.length?new ru(o.rootNodes,o.errors):function s(e,t,n,r,i){return new sh(r,i).merge(e,t,n)}(o.rootNodes,this._translationBundle,r,[],{})},e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function bh(e,t,n){return void 0===n&&(n=null),At(t,new Th(e),n)}var Th=function(){function e(e){this.ctx=e}return e.prototype.visitArray=function(e,t){var n=this;return St(e.map(function(e){return At(e,n,null)}),t)},e.prototype.visitStringMap=function(e,t){var n=this,r=[],i=new Set(e&&e.$quoted$);return Object.keys(e).forEach(function(t){r.push(new qe(t,At(e[t],n,null),i.has(t)))}),new We(r,t)},e.prototype.visitPrimitive=function(e,t){return bt(e,t)},e.prototype.visitOther=function(e,t){return e instanceof ge?e:this.ctx.importExpr(e)},e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Nh(e,t){return{key:e,value:t,quoted:!1}}var Ph=function(){function t(e,t){this.reflector=e,this.alwaysGenerateDef=t,this.tokenInjector=e.resolveExternalReference(on.Injector)}return t.prototype.depsArray=function(e,t){var n=this;return e.map(function(e){var r,i,o=e,s=0;if(Array.isArray(e))for(var a=0;a<e.length;a++){var u=e[a];u&&("Optional"===u.ngMetadataName?s|=8:"SkipSelf"===u.ngMetadataName?s|=4:"Self"===u.ngMetadataName?s|=2:o="Inject"===u.ngMetadataName?u.token:u)}return r="string"==typeof o?bt(o):o===n.tokenInjector?gt(on.INJECTOR):t.importExpr(o),i=0!==s?[r,bt(s)]:[r],gt(on.inject).callFn(i)})},t.prototype.factoryFor=function(e,t){var n;if(e.useExisting)n=gt(on.inject).callFn([t.importExpr(e.useExisting)]);else if(e.useFactory){var r=e.deps||[];if(!(r.length>0))return t.importExpr(e.useFactory);n=t.importExpr(e.useFactory).callFn(this.depsArray(r,t))}else if(e.useValue)n=bh(t,e.useValue);else{var i=e.useClass||e.symbol,o=this.depsArray(this.reflector.parameters(i),t);n=new Me(t.importExpr(i),o)}return wt([],[new Je(n)],void 0,void 0,e.symbol.name+"_Factory")},t.prototype.injectableDef=function(e,t){var n=Ke;void 0!==e.providedIn&&(n=null===e.providedIn?Ke:"string"==typeof e.providedIn?bt(e.providedIn):t.importExpr(e.providedIn));var r=[Nh("factory",this.factoryFor(e,t)),Nh("token",t.importExpr(e.type.reference)),Nh("providedIn",n)];return gt(on.ɵɵdefineInjectable).callFn([xt(r)])},t.prototype.compile=function(t,n){if(this.alwaysGenerateDef||void 0!==t.providedIn){var r=dn(t.type),i=new rt(r,null,[new et("ngInjectableDef",ce,[e.StmtModifier.Static],this.injectableDef(t,n))],[],new tt(null,[],[]),[]);n.statements.push(i)}},t}(),Mh=/(\.ts|\.d\.ts|\.js|\.jsx|\.tsx)$/,Ah=/\.ngfactory\.|\.ngsummary\./,Ih=/\.ngsummary\./,kh=/NgSummary$/;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var tf=function tf(e){this.ngModuleFactoryVar=e},nf=yt("_l"),rf=function(){function t(e){this.reflector=e}return t.prototype.compile=function(e,t,n){var r=zo("NgModule",t.type),i=t.transitiveModule.entryComponents,o=t.bootstrapComponents,s=new Hu(this.reflector,t,n,r),a=[ef(this.reflector,e,0,i)].concat(s.parse().map(function(t){return Gh(e,t)})).map(function(e){var t=e.providerExpr,n=e.depsExpr,r=e.flags,i=e.tokenExpr;return gt(on.moduleProviderDef).callFn([bt(r),i,t,n])}),u=gt(on.moduleDef).callFn([St(a)]),p=wt([new Le(nf.name)],[new Je(u)],ce),l=dn(t.type)+"NgFactory";if(this._createNgModuleFactory(e,t.type.reference,gt(on.createModuleFactory).callFn([e.importExpr(t.type.reference),St(o.map(function(t){return e.importExpr(t.reference)})),p])),t.id){var c="string"==typeof t.id?bt(t.id):e.importExpr(t.id),h=gt(on.RegisterModuleFactoryFn).callFn([c,yt(l)]).toStmt();e.statements.push(h)}return new tf(l)},t.prototype.createStub=function(e,t){this._createNgModuleFactory(e,t,Ke)},t.prototype._createNgModuleFactory=function(t,n,r){var i=yt(dn({reference:n})+"NgFactory").set(r).toDeclStmt(_t(on.NgModuleFactory,[Et(t.importExpr(n))],[te.Const]),[e.StmtModifier.Final,e.StmtModifier.Exported]);t.statements.push(i)},t}(),of=function(){function e(e){this._reflector=e}return e.prototype.isNgModule=function(e){return this._reflector.annotations(e).some(q.isTypeOf)},e.prototype.resolve=function(e,t){void 0===t&&(t=!0);var n=Jc(this._reflector.annotations(e),q.isTypeOf);if(n)return n;if(t)throw new Error("No NgModule metadata found for '"+Wt(e)+"'.");return null},e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function kf(e,t){var n,r,i,s,a=[];try{for(var u=o(e.transitiveModule.providers),p=u.next();!p.done;p=u.next()){var l=p.value,c=l.provider,h=l.module;if(Sn(c.token)===t.ROUTES){var f=Of(c.useValue);try{for(var d=o(f),v=d.next();!v.done;v=d.next())a.push(Rf(v.value,t,h.reference))}catch(e){i={error:e}}finally{try{v&&!v.done&&(s=d.return)&&s.call(d)}finally{if(i)throw i.error}}}}}catch(e){n={error:e}}finally{try{p&&!p.done&&(r=u.return)&&r.call(u)}finally{if(n)throw n.error}}return a}function Of(e,t){var n,r;if(void 0===t&&(t=[]),"string"==typeof e)t.push(e);else if(Array.isArray(e))try{for(var i=o(e),s=i.next();!s.done;s=i.next())Of(s.value,t)}catch(e){n={error:e}}finally{try{s&&!s.done&&(r=i.return)&&r.call(i)}finally{if(n)throw n.error}}else e.loadChildren?Of(e.loadChildren,t):e.children&&Of(e.children,t);return t}function Rf(e,t,n){var r=s(e.split("#"),2),i=t.resolveExternalReference({moduleName:r[0],name:r[1]},n?n.filePath:void 0);return{route:e,module:n||i,referencedModule:i}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var nd="ngFormattedMessage";function rd(e){var t=Bt(function e(t,n){if(void 0===n&&(n=0),!t)return"";var r=t.position?t.position.fileName+"("+(t.position.line+1)+","+(t.position.column+1)+")":"",i=(r&&0===n?r+": ":"")+t.message+(r&&0!==n?" at "+r:"");return""+function e(t){if(t<=0)return"";if(t<6)return[""," ","  ","   ","    ","     "][t];var n=e(Math.floor(t/2));return n+n+(t%2==1?" ":"")}(n)+i+(t.next&&"\n"+e(t.next,n+2)||"")}(e)+".");return t[nd]=!0,t.chain=e,t.position=e.position,t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.Identifiers=on,e.JitCompiler=Dd,e.ConstantPool=Zt,e.DirectiveResolver=$c,e.PipeResolver=pf,e.NgModuleResolver=of,e.DEFAULT_INTERPOLATION_CONFIG=Bi,e.InterpolationConfig=Li,e.NgModuleCompiler=rf,e.ArrayType=ue,e.AssertNotNull=De,e.DYNAMIC_TYPE=le,e.BinaryOperatorExpr=Ve,e.BuiltinType=se,e.CastExpr=Fe,e.ClassField=et,e.ClassMethod=tt,e.ClassStmt=rt,e.CommaExpr=ze,e.CommentStmt=ot,e.ConditionalExpr=Oe,e.DeclareFunctionStmt=$e,e.DeclareVarStmt=Ge,e.Expression=ge,e.ExpressionStatement=Ye,e.ExpressionType=ae,e.ExternalExpr=Ie,e.ExternalReference=ke,e.literalMap=xt,e.FunctionExpr=Be,e.IfStmt=it,e.InstantiateExpr=Me,e.InvokeFunctionExpr=Pe,e.InvokeMethodExpr=Ne,e.JSDocCommentStmt=st,e.LiteralArrayExpr=He,e.LiteralExpr=Ae,e.LiteralMapExpr=We,e.MapType=pe,e.NotExpr=Re,e.ReadKeyExpr=Ue,e.ReadPropExpr=je,e.ReadVarExpr=Ee,e.ReturnStatement=Je,e.ThrowStmt=ut,e.TryCatchStmt=at,e.Type=ie,e.WrappedNodeExpr=xe,e.WriteKeyExpr=Ce,e.WritePropExpr=be,e.WriteVarExpr=we,e.Statement=Xe,e.TypeofExpr=Se,e.collectExternalReferences=function Jd(e){var t=new ft;return t.visitAllStatements(e,null),t.externalReferences},e.EmitterVisitorContext=Gi,e.JitEvaluator=eo,e.ViewCompiler=df,e.findStaticQueryIds=Cf,e.staticViewQueryIds=bf,e.getParseErrors=function Zd(e){return e[jt]||[]},e.isSyntaxError=function ev(e){return e[Vt]},e.syntaxError=Bt,e.Version=Qt,e.TmplAstBoundAttribute=Hn,e.TmplAstBoundEvent=qn,e.TmplAstBoundText=jn,e.TmplAstContent=Kn,e.TmplAstElement=Wn,e.TmplAstReference=Xn,e.TmplAstTemplate=zn,e.TmplAstText=Vn,e.TmplAstTextAttribute=Un,e.TmplAstVariable=Qn,e.R3Identifiers=Bn,e.compileInjector=Go,e.compileNgModule=Xo,e.compilePipeFromMetadata=Jo,e.makeBindingParser=tc,e.parseTemplate=ec,e.compileBaseDefFromMetadata=lc,e.compileComponentFromMetadata=cc,e.compileDirectiveFromMetadata=pc,e.parseHostBindings=Nc,e.verifyHostBindings=Pc,e.publishFacade=qc,e.VERSION=Wc,e.TextAst=xu,e.BoundTextAst=wu,e.AttrAst=Cu,e.BoundElementPropertyAst=Tu,e.BoundEventAst=Nu,e.ReferenceAst=Pu,e.VariableAst=Mu,e.ElementAst=Au,e.EmbeddedTemplateAst=Iu,e.BoundDirectivePropertyAst=ku,e.DirectiveAst=Ou,e.ProviderAst=Ru,e.NgContentAst=Du,e.NullTemplateVisitor=Fu,e.RecursiveTemplateAstVisitor=Lu,e.templateVisitAll=Bu,e.sanitizeIdentifier=cn,e.identifierName=dn,e.identifierModuleUrl=vn,e.viewClassName=mn,e.rendererTypeName=yn,e.hostViewClassName=gn,e.componentFactoryName=_n,e.tokenName=En,e.tokenReference=Sn,e.CompileStylesheetMetadata=xn,e.CompileTemplateMetadata=wn,e.CompileDirectiveMetadata=Cn,e.CompilePipeMetadata=bn,e.CompileShallowModuleMetadata=Tn,e.CompileNgModuleMetadata=Nn,e.TransitiveCompileNgModuleMetadata=Pn,e.ProviderMeta=An,e.flatten=In,e.templateSourceUrl=On,e.sharedStylesheetJitUrl=Rn,e.ngModuleJitUrl=Dn,e.templateJitUrl=Fn,e.createAotUrlResolver=bd,e.createAotCompiler=function tv(e,t,n){var r,i=t.translations||"",o=bd(e),s=new pn,a=new Cd(e,s),u=new Lf(e,s,a),p=new pd(a,u,[],[],n);r=t.enableIvy?new au:new Ch(new au,i,t.i18nFormat,t.missingTranslation,console);var l=new zc({defaultEncapsulation:E.Emulated,useJit:!1,missingTranslation:t.missingTranslation,preserveWhitespaces:t.preserveWhitespaces,strictInjectionParameters:t.strictInjectionParameters}),c=new Qc({get:function(t){return e.loadResource(t)}},o,r,l),h=new rl(new Up),f=new vl,d=new Ep(l,p,h,f,r,console,[]),v=new Wh(l,r,new of(p),new $c(p),new pf(p),a,f,c,console,s,p,n),m=new df(p),y=new lf(t,p);return{compiler:new zf(l,t,e,p,v,d,new Pa(o),m,y,new rf(p),new Ph(p,!!t.enableIvy),new af,a,u),reflector:p}},e.AotCompiler=zf,e.analyzeNgModules=Gf,e.analyzeAndValidateNgModules=$f,e.analyzeFile=Jf,e.analyzeFileForInjectables=Zf,e.mergeAnalyzedFiles=ed,e.GeneratedFile=If,e.toTypeScript=function nv(e,t){if(void 0===t&&(t=""),!e.stmts)throw new Error("Illegal state: No stmts present on GeneratedFile "+e.genFileUrl);return(new af).emitStatements(e.genFileUrl,e.stmts,t)},e.formattedError=rd,e.isFormattedError=function rv(e){return!!e[nd]},e.StaticReflector=pd,e.StaticSymbol=un,e.StaticSymbolCache=pn,e.ResolvedStaticSymbol=Ff,e.StaticSymbolResolver=Lf,e.unescapeIdentifier=Bf,e.unwrapResolvedMetadata=Vf,e.AotSummaryResolver=Cd,e.AstPath=Aa,e.SummaryResolver=Td,e.JitSummaryResolver=Nd,e.CompileReflector=jd,e.createUrlResolverWithoutPackagePrefix=function iv(){return new Ud},e.createOfflineCompileUrlResolver=function ov(){return new Ud(".")},e.UrlResolver=Ud,e.getUrlScheme=function sv(e){var t=qd(e);return t&&t[Vd.Scheme]||""},e.ResourceLoader=Mc,e.ElementSchemaRegistry=ul,e.Extractor=zd,e.I18NHtmlParser=Ch,e.MessageBundle=Mf,e.Serializer=br,e.Xliff=ch,e.Xliff2=vh,e.Xmb=Fr,e.Xtb=_h,e.DirectiveNormalizer=Qc,e.ParserError=es,e.ParseSpan=ts,e.AST=ns,e.Quote=rs,e.EmptyExpr=is,e.ImplicitReceiver=os,e.Chain=ss,e.Conditional=as,e.PropertyRead=us,e.PropertyWrite=ps,e.SafePropertyRead=ls,e.KeyedRead=cs,e.KeyedWrite=hs,e.BindingPipe=fs,e.LiteralPrimitive=ds,e.LiteralArray=vs,e.LiteralMap=ms,e.Interpolation=ys,e.Binary=gs,e.PrefixNot=_s,e.NonNullAssert=Es,e.MethodCall=Ss,e.SafeMethodCall=xs,e.FunctionCall=ws,e.ASTWithSource=Cs,e.TemplateBinding=bs,e.NullAstVisitor=Ts,e.RecursiveAstVisitor=Ns,e.AstTransformer=Ps,e.AstMemoryEfficientTransformer=Ms,e.visitAstChildren=function av(e,t,n){function r(e){t.visit&&t.visit(e,n)||e.visit(t,n)}function i(e){e.forEach(r)}e.visit({visitBinary:function(e){r(e.left),r(e.right)},visitChain:function(e){i(e.expressions)},visitConditional:function(e){r(e.condition),r(e.trueExp),r(e.falseExp)},visitFunctionCall:function(e){e.target&&r(e.target),i(e.args)},visitImplicitReceiver:function(e){},visitInterpolation:function(e){i(e.expressions)},visitKeyedRead:function(e){r(e.obj),r(e.key)},visitKeyedWrite:function(e){r(e.obj),r(e.key),r(e.obj)},visitLiteralArray:function(e){i(e.expressions)},visitLiteralMap:function(e){},visitLiteralPrimitive:function(e){},visitMethodCall:function(e){r(e.receiver),i(e.args)},visitPipe:function(e){r(e.exp),i(e.args)},visitPrefixNot:function(e){r(e.expression)},visitNonNullAssert:function(e){r(e.expression)},visitPropertyRead:function(e){r(e.receiver)},visitPropertyWrite:function(e){r(e.receiver),r(e.value)},visitQuote:function(e){},visitSafeMethodCall:function(e){r(e.receiver),i(e.args)},visitSafePropertyRead:function(e){r(e.receiver)}})},e.ParsedProperty=As,e.ParsedEvent=Is,e.ParsedVariable=ks,e.BoundElementProperty=Os,e.Lexer=Up,e.Token=Hp,e.EOF=zp,e.isIdentifier=Xp,e.isQuote=Yp,e.SplitInterpolation=Zp,e.TemplateBindingParseResult=el,e.Parser=rl,e._ParseAST=il,e.ERROR_COMPONENT_TYPE="ngComponentType",e.CompileMetadataResolver=Wh,e.Text=Ia,e.Expansion=ka,e.ExpansionCase=Oa,e.Attribute=Ra,e.Element=Da,e.Comment=Fa,e.visitAll=La,e.RecursiveVisitor=Va,e.findNode=function uv(e,t){var r=[];return La(new(function(e){function i(){return null!==e&&e.apply(this,arguments)||this}return n(i,e),i.prototype.visit=function(e,n){var i=function e(t){var n=t.sourceSpan.start.offset,r=t.sourceSpan.end.offset;return t instanceof Da&&(t.endSourceSpan?r=t.endSourceSpan.end.offset:t.children&&t.children.length&&(r=e(t.children[t.children.length-1]).end)),{start:n,end:r}}(e);if(!(i.start<=t&&t<i.end))return!0;r.push(e)},i}(Va)),e),new Aa(r,t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.HtmlParser=au,e.ParseTreeResult=ru,e.TreeError=nu,e.HtmlTagDefinition=g,e.getHtmlTagDefinition=_,e.splitNsName=u,e.isNgContainer=p,e.isNgContent=l,e.isNgTemplate=c,e.getNsPrefix=h,e.mergeNsAndName=f,e.NAMED_ENTITIES=d,e.NGSP_UNICODE=v,e.debugOutputAstAsTypeScript=sf,e.TypeScriptEmitter=af,e.ParseLocation=Uo,e.ParseSourceFile=Ho,e.ParseSourceSpan=qo,e.ParseError=Wo,e.typeSourceSpan=zo,e.r3JitTypeSourceSpan=Ko,e.DomElementSchemaRegistry=vl,e.CssSelector=w,e.SelectorMatcher=C,e.SelectorListContext=b,e.SelectorContext=T,e.HOST_ATTR=Ca,e.CONTENT_ATTR=ba,e.StylesCompileDependency=Ta,e.CompiledStylesheet=Na,e.StyleCompiler=Pa,e.TemplateParseError=gp,e.TemplateParseResult=_p,e.TemplateParser=Ep,e.splitClasses=Cp,e.createElementCssSelector=Tp,e.removeSummaryDuplicates=Ap,e.isEmptyExpression=Ip,e.compileInjectable=Oi,e.R3TargetBinder=Kd,e.R3BoundTarget=$d,Object.defineProperty(e,"__esModule",{value:!0})});