...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Fo(e){var t=new no;return null!==e.providers&&t.set("providers",e.providers),e.imports.length>0&&t.set("imports",Ft(e.imports)),{expression:kt(rr.defineInjector).callFn([t.toLiteralMap()],void 0,!0),type:Lo(e),statements:[]}}function Lo(e){return new se(kt(rr.InjectorDef,[new se(e.type.type)]))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
