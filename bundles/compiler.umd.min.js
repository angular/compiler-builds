...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var uh=function(e){function t(){return e.call(this,ah)||this}return n(t,e),t.prototype.parse=function(t,n,r){return e.prototype.parse.call(this,t,n,r)},t}(iu),ph=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return n(t,e),t.prototype.write=function(e,t){var n=new lh,r=[];e.forEach(function(e){var t,i=[];e.sources.forEach(function(e){var t=new Ir("context-group",{purpose:"location"});t.children.push(new Rr(10),new Ir("context",{"context-type":"sourcefile"},[new kr(e.filePath)]),new Rr(10),new Ir("context",{"context-type":"linenumber"},[new kr(""+e.startLine)]),new Rr(8)),i.push(new Rr(8),t)});var o=new Ir("trans-unit",{id:e.id,datatype:"html"});(t=o.children).push.apply(t,a([new Rr(8),new Ir("source",{},n.serialize(e.nodes))],i)),e.description&&o.children.push(new Rr(8),new Ir("note",{priority:"1",from:"description"},[new kr(e.description)])),e.meaning&&o.children.push(new Rr(8),new Ir("note",{priority:"1",from:"meaning"},[new kr(e.meaning)])),o.children.push(new Rr(6)),r.push(new Rr(6),o)});var i=new Ir("body",{},a(r,[new Rr(4)])),o=new Ir("file",{"source-language":t||"en",datatype:"plaintext",original:"ng2.template"},[new Rr(4),i,new Rr(2)]),s=new Ir("xliff",{version:"1.2",xmlns:"urn:oasis:names:tc:xliff:document:1.2"},[new Rr(2),o,new Rr]);return Nr([new Mr({version:"1.0",encoding:"UTF-8"}),new Rr,s,new Rr])},t.prototype.load=function(e,t){var n=(new ch).parse(e,t),r=n.locale,i=n.msgIdToHtml,o=n.errors,s={},u=new hh;if(Object.keys(i).forEach(function(e){var n=u.convert(i[e],t),r=n.i18nNodes;o.push.apply(o,a(n.errors)),s[e]=r}),o.length)throw new Error("xliff parse errors:\n"+o.join("\n"));return{locale:r,i18nNodesByMsgId:s}},t.prototype.digest=function(e){return sr(e)},t}(br),lh=function(){function e(){}return e.prototype.visitText=function(e,t){return[new kr(e.value)]},e.prototype.visitContainer=function(e,t){var n=this,r=[];return e.children.forEach(function(e){return r.push.apply(r,a(e.visit(n)))}),r},e.prototype.visitIcu=function(e,t){var n=this,r=[new kr("{"+e.expressionPlaceholder+", "+e.type+", ")];return Object.keys(e.cases).forEach(function(t){r.push.apply(r,a([new kr(t+" {")],e.cases[t].visit(n),[new kr("} ")]))}),r.push(new kr("}")),r},e.prototype.visitTagPlaceholder=function(e,t){var n=function r(e){switch(e.toLowerCase()){case"br":return"lb";case"img":return"image";default:return"x-"+e}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
