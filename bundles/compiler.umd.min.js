...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.createOfflineCompileUrlResolver=function $d(){return new Md(".")},e.createUrlResolverWithoutPackagePrefix=function Yd(){return new Md},e.debugOutputAstAsTypeScript=tf,e.devOnlyGuardedExpression=function Jd(e){return _r("ngDevMode",e)},e.findNode=function Zd(e,t){var n=[];return Oa(new(function(e){function i(){return null!==e&&e.apply(this,arguments)||this}return r(i,e),i.prototype.visit=function(e,r){var i=function e(t){var n=t.sourceSpan.start.offset,r=t.sourceSpan.end.offset;return t instanceof Ia&&(t.endSourceSpan?r=t.endSourceSpan.end.offset:t.children&&t.children.length&&(r=e(t.children[t.children.length-1]).end)),{start:n,end:r}}(e);if(!(i.start<=t&&t<i.end))return!0;n.push(e)},i}(Da)),e),new Ta(n,t)},e.flatten=$n,e.formattedError=$f,e.getHtmlTagDefinition=y,e.getNsPrefix=c,e.getParseErrors=function ev(e){return e[gn]||[]},e.getSafePropertyAccessString=gr,e.getUrlScheme=function tv(e){var t=Nd(e);return t&&t[bd.Scheme]||""},e.hostViewClassName=Ln,e.identifierModuleUrl=Rn,e.identifierName=On,e.isEmptyExpression=yp,e.isFormattedError=function nv(e){return!!e.ngFormattedMessage},e.isIdentifier=kp,e.isLoweredSymbol=Bh,e.isNgContainer=u,e.isNgContent=p,e.isNgTemplate=l,e.isQuote=Dp,e.isSyntaxError=function rv(e){return e[yn]},e.jsDocComment=At,e.leadingComment=function iv(e,t,n){return void 0===t&&(t=!1),void 0===n&&(n=!0),new at(e,t,n)},e.literalMap=Lt,e.makeBindingParser=Jl,e.mergeAnalyzedFiles=Xf,e.mergeNsAndName=h,e.ngModuleJitUrl=er,e.parseHostBindings=_c,e.parseTemplate=$l,e.preserveWhitespacesDefault=zc,e.publishFacade=Hc,e.r3JitTypeSourceSpan=Do,e.removeSummaryDuplicates=mp,e.rendererTypeName=Fn,e.sanitizeIdentifier=An,e.sharedStylesheetJitUrl=Zn,e.splitClasses=lp,e.splitNsName=a,e.syntaxError=mn,e.templateJitUrl=tr,e.templateSourceUrl=Jn,e.templateVisitAll=Ou,e.toTypeScript=function ov(e,t){if(void 0===t&&(t=""),!e.stmts)throw new Error("Illegal state: No stmts present on GeneratedFile "+e.genFileUrl);return(new nf).emitStatements(e.genFileUrl,e.stmts,t)},e.tokenName=Vn,e.tokenReference=jn,e.typeSourceSpan=Ro,e.unescapeIdentifier=kf,e.unwrapResolvedMetadata=Of,e.verifyHostBindings=Sc,e.viewClassName=Dn,e.visitAll=Oa,Object.defineProperty(e,"__esModule",{value:!0})}));