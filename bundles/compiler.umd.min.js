...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function No(e,t){if(null!=t){if(!Array.isArray(t))throw new Error("Expected '"+e+"' to be an array of strings.");for(var n=0;n<t.length;n+=1)if("string"!=typeof t[n])throw new Error("Expected '"+e+"' to be an array of strings.")}}var Po=[/^\s*$/,/[<>]/,/^[{}]$/,/&(#|[a-z])/i,/^\/\//];function Mo(e,t){if(!(null==t||Array.isArray(t)&&2==t.length))throw new Error("Expected '"+e+"' to be an array, [start, end].");if(null!=t){var n=t[0],r=t[1];Po.forEach(function(e){if(e.test(n)||e.test(r))throw new Error("['"+n+"', '"+r+"'] contains unusable interpolation symbol.")})}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.HtmlParser=pu,e.ParseTreeResult=ou,e.TreeError=iu,e.HtmlTagDefinition=g,e.getHtmlTagDefinition=_,e.splitNsName=u,e.isNgContainer=p,e.isNgContent=l,e.isNgTemplate=c,e.getNsPrefix=h,e.mergeNsAndName=f,e.NAMED_ENTITIES=d,e.NGSP_UNICODE=v,e.debugOutputAstAsTypeScript=pf,e.TypeScriptEmitter=lf,e.ParseLocation=wr,e.ParseSourceFile=Cr,e.ParseSourceSpan=br,e.ParseError=Tr,e.typeSourceSpan=Nr,e.r3JitTypeSourceSpan=Pr,e.DomElementSchemaRegistry=El,e.CssSelector=w,e.SelectorMatcher=C,e.SelectorListContext=b,e.SelectorContext=T,e.HOST_ATTR=Ta,e.CONTENT_ATTR=Na,e.StylesCompileDependency=Pa,e.CompiledStylesheet=Ma,e.StyleCompiler=Aa,e.TemplateParseError=Ep,e.TemplateParseResult=Sp,e.TemplateParser=xp,e.splitClasses=Tp,e.createElementCssSelector=Pp,e.removeSummaryDuplicates=kp,e.isEmptyExpression=Rp,e.compileInjectable=To,e.R3TargetBinder=Gd,e.R3BoundTarget=Zd,Object.defineProperty(e,"__esModule",{value:!0})});