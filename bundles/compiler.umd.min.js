...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.createOfflineCompileUrlResolver=function Xd(){return new Md(".")},e.createUrlResolverWithoutPackagePrefix=function Gd(){return new Md},e.debugOutputAstAsTypeScript=tf,e.devOnlyGuardedExpression=function $d(e){return Sr("ngDevMode",e)},e.findNode=function Yd(e,t){var n=[];return ka(new(function(e){function i(){return null!==e&&e.apply(this,arguments)||this}return r(i,e),i.prototype.visit=function(e,r){var i=function e(t){var n=t.sourceSpan.start.offset,r=t.sourceSpan.end.offset;return t instanceof Aa&&(t.endSourceSpan?r=t.endSourceSpan.end.offset:t.children&&t.children.length&&(r=e(t.children[t.children.length-1]).end)),{start:n,end:r}}(e);if(!(i.start<=t&&t<i.end))return!0;n.push(e)},i}(Ra)),e),new ba(n,t)},e.flatten=$n,e.formattedError=$f,e.getHtmlTagDefinition=y,e.getMissingNgModuleMetadataErrorData=function Jd(e){var t;return null!==(t=e.ngMissingNgModuleMetadataErrorData)&&void 0!==t?t:null},e.getNsPrefix=c,e.getParseErrors=function Zd(e){return e[gn]||[]},e.getSafePropertyAccessString=Er,e.getUrlScheme=function ev(e){var t=Nd(e);return t&&t[bd.Scheme]||""},e.hostViewClassName=Ln,e.identifierModuleUrl=Rn,e.identifierName=On,e.isEmptyExpression=mp,e.isFormattedError=function tv(e){return!!e.ngFormattedMessage},e.isIdentifier=Ip,e.isLoweredSymbol=Bh,e.isNgContainer=u,e.isNgContent=p,e.isNgTemplate=l,e.isQuote=Rp,e.isSyntaxError=function nv(e){return e[yn]},e.jsDocComment=At,e.leadingComment=function rv(e,t,n){return void 0===t&&(t=!1),void 0===n&&(n=!0),new at(e,t,n)},e.literalMap=Lt,e.makeBindingParser=Yl,e.mergeAnalyzedFiles=Xf,e.mergeNsAndName=h,e.ngModuleJitUrl=er,e.parseHostBindings=Ec,e.parseTemplate=Gl,e.preserveWhitespacesDefault=zc,e.publishFacade=Hc,e.r3JitTypeSourceSpan=Do,e.removeSummaryDuplicates=vp,e.rendererTypeName=Fn,e.sanitizeIdentifier=An,e.sharedStylesheetJitUrl=Zn,e.splitClasses=pp,e.splitNsName=a,e.syntaxError=mn,e.templateJitUrl=tr,e.templateSourceUrl=Jn,e.templateVisitAll=ku,e.toTypeScript=function iv(e,t){if(void 0===t&&(t=""),!e.stmts)throw new Error("Illegal state: No stmts present on GeneratedFile "+e.genFileUrl);return(new nf).emitStatements(e.genFileUrl,e.stmts,t)},e.tokenName=Vn,e.tokenReference=jn,e.typeSourceSpan=Ro,e.unescapeIdentifier=kf,e.unwrapResolvedMetadata=Of,e.verifyHostBindings=_c,e.viewClassName=Dn,e.visitAll=ka,Object.defineProperty(e,"__esModule",{value:!0})}));