...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.AST=Ko,e.ASTWithName=Qo,e.ASTWithSource=gs,e.AbsoluteSourceSpan=ys,e.AotCompiler=Vf,e.AotSummaryResolver=ld,e.ArrayType=ae,e.AssertNotNull=Qe,e.AstMemoryEfficientTransformer=ws,e.AstPath=ba,e.AstTransformer=xs,e.AttrAst=gu,e.Attribute=Na,e.Binary=ls,e.BinaryOperatorExpr=Je,e.BindingPipe=os,e.BoundDirectivePropertyAst=Tu,e.BoundElementProperty=Ms,e.BoundElementPropertyAst=_u,e.BoundEventAst=Su,e.BoundTextAst=yu,e.BuiltinType=oe,e.CONTENT_ATTR="_ngcontent-%COMP%",e.CUSTOM_ELEMENTS_SCHEMA=q,e.CastExpr=Xe,e.Chain=Jo,e.ClassField=vt,e.ClassMethod=mt,e.ClassStmt=gt,e.CommaExpr=it,e.Comment=Ia,e.CompileDirectiveMetadata=qn,e.CompileMetadataResolver=jh,e.CompileNgModuleMetadata=Kn,e.CompilePipeMetadata=Wn,e.CompileReflector=Td,e.CompileShallowModuleMetadata=zn,e.CompileStylesheetMetadata=Un,e.CompileTemplateMetadata=Hn,e.CompiledStylesheet=Sa,e.CompilerConfig=Wc,e.Conditional=Zo,e.ConditionalExpr=ze,e.ConstantPool=Qt,e.CssSelector=S,e.DEFAULT_INTERPOLATION_CONFIG=yo,e.DYNAMIC_TYPE=pe,e.DeclareFunctionStmt=ct,e.DeclareVarStmt=lt,e.DirectiveAst=Pu,e.DirectiveNormalizer=Kc,e.DirectiveResolver=Gc,e.DomElementSchemaRegistry=Jp,e.EOF=Mp,e.ERROR_COMPONENT_TYPE="ngComponentType",e.Element=Aa,e.ElementAst=Cu,e.ElementSchemaRegistry=Xp,e.EmbeddedTemplateAst=bu,e.EmitterVisitorContext=hr,e.EmptyExpr=Go,e.Expansion=Pa,e.ExpansionCase=Ma,e.Expression=Ee,e.ExpressionBinding=_s,e.ExpressionStatement=ht,e.ExpressionType=se,e.ExternalExpr=qe,e.ExternalReference=We,e.Extractor=Id,e.FunctionCall=ms,e.FunctionExpr=$e,e.GeneratedFile=bf,e.HOST_ATTR="_nghost-%COMP%",e.HtmlParser=ru,e.HtmlTagDefinition=m,e.I18NHtmlParser=_h,e.Identifiers=Jt,e.IfStmt=Et,e.ImplicitReceiver=$o,e.InstantiateExpr=Ie,e.Interpolation=ps,e.InterpolationConfig=mo,e.InvokeFunctionExpr=Ne,e.InvokeMethodExpr=Me,e.IvyParser=jp,e.JSDocComment=ut,e.JitCompiler=Sd,e.JitEvaluator=xo,e.JitSummaryResolver=fd,e.KeyedRead=rs,e.KeyedWrite=is,e.LeadingComment=at,e.Lexer=Cp,e.LiteralArray=as,e.LiteralArrayExpr=tt,e.LiteralExpr=ke,e.LiteralMap=us,e.LiteralMapExpr=rt,e.LiteralPrimitive=ss,e.LocalizedString=Le,e.MapType=ue,e.MessageBundle=wf,e.MethodCall=ds,e.NAMED_ENTITIES=v,e.NGSP_UNICODE="",e.NONE_TYPE=de,e.NO_ERRORS_SCHEMA=W,e.NgContentAst=Nu,e.NgModuleCompiler=Zh,e.NgModuleResolver=ef,e.NodeWithI18n=Ca,e.NonNullAssert=fs,e.NotExpr=Ke,e.NullTemplateVisitor=Au,e.ParseError=Oo,e.ParseLocation=Ao,e.ParseSourceFile=Io,e.ParseSourceSpan=ko,e.ParseSpan=zo,e.ParseTreeResult=Za,e.ParsedEvent=Ts,e.ParsedProperty=Cs,e.ParsedVariable=Ps,e.Parser=Vp,e.ParserError=Wo,e.PipeResolver=of,e.PrefixNot=hs,e.PropertyRead=es,e.PropertyWrite=ts,e.ProviderAst=Mu,e.ProviderMeta=Gn,e.Quote=Xo,e.R3BoundTarget=Fd,e.R3Identifiers=rr,e.R3TargetBinder=kd,e.ReadKeyExpr=et,e.ReadPropExpr=Ze,e.ReadVarExpr=Se,e.RecursiveAstVisitor=Ss,e.RecursiveTemplateAstVisitor=Iu,e.RecursiveVisitor=Ra,e.ReferenceAst=xu,e.ResolvedStaticSymbol=Af,e.ResourceLoader=Sc,e.ReturnStatement=ft,e.STRING_TYPE=fe,e.SafeMethodCall=vs,e.SafePropertyRead=ns,e.SelectorContext=C,e.SelectorListContext=w,e.SelectorMatcher=x,e.Serializer=vi,e.SplitInterpolation=Lp,e.Statement=pt,e.StaticReflector=nd,e.StaticSymbol=nn,e.StaticSymbolCache=rn,e.StaticSymbolResolver=If,e.StyleCompiler=xa,e.StylesCompileDependency=_a,e.SummaryResolver=hd,e.TaggedTemplateExpr=Ae,e.TemplateBindingParseResult=Bp,e.TemplateLiteral=Oe,e.TemplateLiteralElement=Re,e.TemplateParseError=rp,e.TemplateParseResult=ip,e.TemplateParser=op,e.Text=Ta,e.TextAst=mu,e.ThisReceiver=Yo,e.ThrowStmt=St,e.TmplAstBoundAttribute=Tr,e.TmplAstBoundEvent=Pr,e.TmplAstBoundText=Cr,e.TmplAstContent=Ar,e.TmplAstElement=Mr,e.TmplAstIcu=Or,e.TmplAstRecursiveVisitor=Rr,e.TmplAstReference=kr,e.TmplAstTemplate=Nr,e.TmplAstText=wr,e.TmplAstTextAttribute=br,e.TmplAstVariable=Ir,e.Token=bp,e.TransitiveCompileNgModuleMetadata=Qn,e.TreeError=Ja,e.TryCatchStmt=_t,e.Type=ne,e.TypeScriptEmitter=nf,e.TypeofExpr=xe,e.Unary=cs,e.UnaryOperatorExpr=Ye,e.UrlResolver=Pd,e.VERSION=qc,e.VariableAst=wu,e.VariableBinding=Es,e.Version=Cn,e.ViewCompiler=lf,e.WrappedNodeExpr=we,e.WriteKeyExpr=be,e.WritePropExpr=Te,e.WriteVarExpr=Ce,e.Xliff=ah,e.Xliff2=ch,e.Xmb=Ti,e.XmlParser=sh,e.Xtb=vh,e._ParseAST=Hp,e.analyzeAndValidateNgModules=Wf,e.analyzeFile=Kf,e.analyzeFileForInjectables=Qf,e.analyzeNgModules=qf,e.collectExternalReferences=function Hd(e){var t=new Tt;return t.visitAllStatements(e,null),t.externalReferences},e.compileComponentFromMetadata=ac,e.compileDeclareComponentFromMetadata=function qd(e,t){var n=function r(e,t){var n=Vd(e);return n.set("template",function r(e){if("string"==typeof e.template){if(e.isInline)return Ut(e.template);var t=e.template,n=new Io(t,e.templateUrl),r=new Ao(n,0,0,0),i=function o(e,t){var n=t.length,r=0,i=0,o=0;do{-1!==(r=t.indexOf("\n",i))&&(i=r+1,o++)}while(-1!==r);return new Ao(e,n,o,n-i)}(n,t);return Ut(t,null,new ko(r,i))}return e.template}(t)),t.isInline&&n.set("isInline",Ut(!0)),n.set("styles",Ld(e.styles,Ut)),n.set("directives",function s(e){var t=0!==e.declarationListEmitMode?Ud:function(e){return e};return Ld(e.directives,(function(e){var n=new no;return n.set("type",t(e.type)),n.set("selector",Ut(e.selector)),n.set("inputs",Ld(e.inputs,Ut)),n.set("outputs",Ld(e.outputs,Ut)),n.set("exportAs",Ld(e.exportAs,Ut)),n.toLiteralMap()}))}(e)),n.set("pipes",function a(e){var t,n;if(0===e.pipes.size)return null;var r=0!==e.declarationListEmitMode?Ud:function(e){return e},s=[];try{for(var a=i(e.pipes),u=a.next();!u.done;u=a.next()){var p=o(u.value,2);s.push({key:p[0],value:r(p[1]),quoted:!0})}}catch(e){t={error:e}}finally{try{u&&!u.done&&(n=a.return)&&n.call(a)}finally{if(t)throw t.error}}return Lt(s)}(e)),n.set("viewProviders",e.viewProviders),n.set("animations",e.animations),void 0!==e.changeDetection&&n.set("changeDetection",kt(rr.ChangeDetectionStrategy).prop(E[e.changeDetection])),e.encapsulation!==g.Emulated&&n.set("encapsulation",kt(rr.ViewEncapsulation).prop(g[e.encapsulation])),e.interpolation!==yo&&n.set("interpolation",Ft([Ut(e.interpolation.start),Ut(e.interpolation.end)])),!0===t.preserveWhitespaces&&n.set("preserveWhitespaces",Ut(!0)),n}(e,t);return{expression:kt(rr.declareComponent).callFn([n.toLiteralMap()]),type:uc(e)}},e.compileDeclareDirectiveFromMetadata=function Wd(e){var t=Vd(e);return{expression:kt(rr.declareDirective).callFn([t.toLiteralMap()]),type:vc(e)}},e.compileDeclarePipeFromMetadata=function zd(e){var t=function n(e){var t=new no;return t.set("version",Ut("11.2.8+30.sha-f8986e1")),t.set("ngImport",kt(rr.core)),t.set("type",e.internalType),t.set("name",Ut(e.pipeName)),!1===e.pure&&t.set("pure",Ut(e.pure)),t}(e);return{expression:kt(rr.declarePipe).callFn([t.toLiteralMap()]),type:Ho(e)}},e.compileDirectiveFromMetadata=sc,e.compileFactoryFunction=so,e.compileInjectable=po,e.compileInjector=Bo,e.compileNgModule=Lo,e.compilePipeFromMetadata=Uo,e.componentFactoryName=Bn,e.computeMsgId=oi,e.core=ee,e.createAotCompiler=function Kd(e,t,n){var r,i=t.translations||"",o=cd(e),s=new rn,a=new ld(e,s),u=new If(e,s,a),p=new nd(a,u,[],[],n);r=t.enableIvy?new ru:new _h(new ru,i,t.i18nFormat,t.missingTranslation,console);var l=new Wc({defaultEncapsulation:g.Emulated,useJit:!1,missingTranslation:t.missingTranslation,preserveWhitespaces:t.preserveWhitespaces,strictInjectionParameters:t.strictInjectionParameters}),c=new Kc({get:function(t){return e.loadResource(t)}},o,r,l),h=new Vp(new Cp),f=new Jp,d=new op(l,p,h,f,r,console,[]),v=new jh(l,r,new ef(p),new Gc(p),new of(p),a,f,c,console,s,p,n),m=new lf(p),y=new sf(t,p);return{compiler:new Vf(l,t,e,p,v,d,new xa(o),m,y,new Zh(p),new Ch(p,!!t.enableIvy),new nf,a,u),reflector:p}},e.createAotUrlResolver=cd,e.createElementCssSelector=cp,e.createLoweredSymbol=function Qd(e){return"ɵ"+e}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.createOfflineCompileUrlResolver=function Xd(){return new Pd(".")},e.createUrlResolverWithoutPackagePrefix=function Gd(){return new Pd},e.debugOutputAstAsTypeScript=tf,e.devOnlyGuardedExpression=function $d(e){return Sr("ngDevMode",e)},e.findNode=function Yd(e,t){var n=[];return ka(new(function(e){function i(){return null!==e&&e.apply(this,arguments)||this}return r(i,e),i.prototype.visit=function(e,r){var i=function e(t){var n=t.sourceSpan.start.offset,r=t.sourceSpan.end.offset;return t instanceof Aa&&(t.endSourceSpan?r=t.endSourceSpan.end.offset:t.children&&t.children.length&&(r=e(t.children[t.children.length-1]).end)),{start:n,end:r}}(e);if(!(i.start<=t&&t<i.end))return!0;n.push(e)},i}(Ra)),e),new ba(n,t)},e.flatten=$n,e.formattedError=$f,e.getHtmlTagDefinition=y,e.getNsPrefix=c,e.getParseErrors=function Jd(e){return e[gn]||[]},e.getSafePropertyAccessString=Er,e.getUrlScheme=function Zd(e){var t=Nd(e);return t&&t[bd.Scheme]||""},e.hostViewClassName=Ln,e.identifierModuleUrl=Rn,e.identifierName=On,e.isEmptyExpression=mp,e.isFormattedError=function ev(e){return!!e.ngFormattedMessage},e.isIdentifier=Ip,e.isLoweredSymbol=Bh,e.isNgContainer=u,e.isNgContent=p,e.isNgTemplate=l,e.isQuote=Rp,e.isSyntaxError=function tv(e){return e[yn]},e.jsDocComment=At,e.leadingComment=function nv(e,t,n){return void 0===t&&(t=!1),void 0===n&&(n=!0),new at(e,t,n)},e.literalMap=Lt,e.makeBindingParser=Yl,e.mergeAnalyzedFiles=Xf,e.mergeNsAndName=h,e.ngModuleJitUrl=er,e.parseHostBindings=Ec,e.parseTemplate=Gl,e.preserveWhitespacesDefault=zc,e.publishFacade=Hc,e.r3JitTypeSourceSpan=Do,e.removeSummaryDuplicates=vp,e.rendererTypeName=Fn,e.sanitizeIdentifier=An,e.sharedStylesheetJitUrl=Zn,e.splitClasses=pp,e.splitNsName=a,e.syntaxError=mn,e.templateJitUrl=tr,e.templateSourceUrl=Jn,e.templateVisitAll=ku,e.toTypeScript=function rv(e,t){if(void 0===t&&(t=""),!e.stmts)throw new Error("Illegal state: No stmts present on GeneratedFile "+e.genFileUrl);return(new nf).emitStatements(e.genFileUrl,e.stmts,t)},e.tokenName=Vn,e.tokenReference=jn,e.typeSourceSpan=Ro,e.unescapeIdentifier=kf,e.unwrapResolvedMetadata=Of,e.verifyHostBindings=_c,e.viewClassName=Dn,e.visitAll=ka,Object.defineProperty(e,"__esModule",{value:!0})}));