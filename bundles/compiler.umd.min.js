...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.AST=Xo,e.ASTWithName=Go,e.ASTWithSource=_s,e.AbsoluteSourceSpan=Es,e.AotCompiler=zf,e.AotSummaryResolver=md,e.ArrayType=ae,e.AssertNotNull=Qe,e.AstMemoryEfficientTransformer=bs,e.AstPath=ba,e.AstTransformer=Cs,e.AttrAst=Eu,e.Attribute=Na,e.Binary=hs,e.BinaryOperatorExpr=Je,e.BindingPipe=as,e.BoundDirectivePropertyAst=Pu,e.BoundElementProperty=As,e.BoundElementPropertyAst=Su,e.BoundEventAst=xu,e.BoundTextAst=gu,e.BuiltinType=oe,e.CONTENT_ATTR="_ngcontent-%COMP%",e.CUSTOM_ELEMENTS_SCHEMA=q,e.CastExpr=Xe,e.Chain=es,e.ClassField=vt,e.ClassMethod=mt,e.ClassStmt=gt,e.CommaExpr=it,e.Comment=Ia,e.CompileDirectiveMetadata=qn,e.CompileMetadataResolver=Kh,e.CompileNgModuleMetadata=Kn,e.CompilePipeMetadata=Wn,e.CompileReflector=Od,e.CompileShallowModuleMetadata=zn,e.CompileStylesheetMetadata=Un,e.CompileTemplateMetadata=Hn,e.CompiledStylesheet=Sa,e.CompilerConfig=$c,e.Conditional=ts,e.ConditionalExpr=ze,e.ConstantPool=gn,e.CssSelector=S,e.DEFAULT_INTERPOLATION_CONFIG=go,e.DYNAMIC_TYPE=pe,e.DeclareFunctionStmt=ct,e.DeclareVarStmt=lt,e.DirectiveAst=Mu,e.DirectiveNormalizer=Jc,e.DirectiveResolver=th,e.DomElementSchemaRegistry=Jp,e.EOF=Np,e.ERROR_COMPONENT_TYPE="ngComponentType",e.Element=Aa,e.ElementAst=bu,e.ElementSchemaRegistry=Xp,e.EmbeddedTemplateAst=Tu,e.EmitterVisitorContext=hr,e.EmptyExpr=Yo,e.Expansion=Pa,e.ExpansionCase=Ma,e.Expression=Ee,e.ExpressionBinding=xs,e.ExpressionStatement=ht,e.ExpressionType=se,e.ExternalExpr=qe,e.ExternalReference=We,e.Extractor=Ld,e.FunctionCall=gs,e.FunctionExpr=$e,e.GeneratedFile=If,e.HOST_ATTR="_nghost-%COMP%",e.HtmlParser=ru,e.HtmlTagDefinition=m,e.I18NHtmlParser=Th,e.Identifiers=wn,e.IfStmt=Et,e.ImplicitReceiver=Jo,e.InstantiateExpr=Ie,e.Interpolation=cs,e.InterpolationConfig=yo,e.InvokeFunctionExpr=Ne,e.InvokeMethodExpr=Me,e.IvyParser=Up,e.JSDocComment=ut,e.JitCompiler=Pd,e.JitEvaluator=wo,e.JitSummaryResolver=Ed,e.KeyedRead=os,e.KeyedWrite=ss,e.LeadingComment=at,e.Lexer=bp,e.LiteralArray=ps,e.LiteralArrayExpr=tt,e.LiteralExpr=Oe,e.LiteralMap=ls,e.LiteralMapExpr=rt,e.LiteralPrimitive=us,e.LocalizedString=Le,e.MapType=ue,e.MessageBundle=Nf,e.MethodCall=ms,e.NAMED_ENTITIES=v,e.NGSP_UNICODE="",e.NONE_TYPE=de,e.NO_ERRORS_SCHEMA=W,e.NgContentAst=Au,e.NgModuleCompiler=sf,e.NgModuleResolver=af,e.NodeWithI18n=Ca,e.NonNullAssert=vs,e.NotExpr=Ke,e.NullTemplateVisitor=Iu,e.ParseError=Ro,e.ParseLocation=Io,e.ParseSourceFile=Oo,e.ParseSourceSpan=ko,e.ParseSpan=Qo,e.ParseTreeResult=Za,e.ParsedEvent=Ms,e.ParsedProperty=Ts,e.ParsedVariable=Ns,e.Parser=jp,e.ParserError=Ko,e.PipeResolver=cf,e.PrefixNot=ds,e.PropertyRead=ns,e.PropertyWrite=rs,e.ProviderAst=Nu,e.ProviderMeta=Gn,e.Quote=$o,e.R3BoundTarget=Hd,e.R3Identifiers=rr,e.R3TargetBinder=Bd,e.ReadKeyExpr=et,e.ReadPropExpr=Ze,e.ReadVarExpr=Se,e.RecursiveAstVisitor=ws,e.RecursiveTemplateAstVisitor=Ou,e.RecursiveVisitor=Ra,e.ReferenceAst=wu,e.ResolvedStaticSymbol=Ff,e.ResourceLoader=Pc,e.ReturnStatement=ft,e.STRING_TYPE=fe,e.SafeMethodCall=ys,e.SafePropertyRead=is,e.SelectorContext=C,e.SelectorListContext=w,e.SelectorMatcher=x,e.Serializer=vi,e.SplitInterpolation=Bp,e.Statement=pt,e.StaticReflector=ud,e.StaticSymbol=Pn,e.StaticSymbolCache=Mn,e.StaticSymbolResolver=Lf,e.StyleCompiler=xa,e.StylesCompileDependency=_a,e.SummaryResolver=gd,e.TaggedTemplateExpr=Ae,e.TemplateBindingParseResult=Vp,e.TemplateLiteral=ke,e.TemplateLiteralElement=Re,e.TemplateParseError=ip,e.TemplateParseResult=op,e.TemplateParser=sp,e.Text=Ta,e.TextAst=yu,e.ThisReceiver=Zo,e.ThrowStmt=St,e.TmplAstBoundAttribute=Tr,e.TmplAstBoundEvent=Pr,e.TmplAstBoundText=Cr,e.TmplAstContent=Ar,e.TmplAstElement=Mr,e.TmplAstIcu=kr,e.TmplAstRecursiveVisitor=Rr,e.TmplAstReference=Or,e.TmplAstTemplate=Nr,e.TmplAstText=wr,e.TmplAstTextAttribute=br,e.TmplAstVariable=Ir,e.Token=Tp,e.TransitiveCompileNgModuleMetadata=Qn,e.TreeError=Ja,e.TryCatchStmt=_t,e.Type=ne,e.TypeScriptEmitter=pf,e.TypeofExpr=xe,e.Unary=fs,e.UnaryOperatorExpr=Ye,e.UrlResolver=kd,e.VERSION=Gc,e.VariableAst=Cu,e.VariableBinding=Ss,e.Version=ln,e.ViewCompiler=mf,e.WrappedNodeExpr=we,e.WriteKeyExpr=be,e.WritePropExpr=Te,e.WriteVarExpr=Ce,e.Xliff=fh,e.Xliff2=yh,e.Xmb=Ti,e.XmlParser=hh,e.Xtb=Sh,e._ParseAST=qp,e.analyzeAndValidateNgModules=$f,e.analyzeFile=Jf,e.analyzeFileForInjectables=Zf,e.analyzeNgModules=Gf,e.collectExternalReferences=function Xd(e){var t=new Tt;return t.visitAllStatements(e,null),t.externalReferences},e.compileComponentFromMetadata=pc,e.compileDeclareComponentFromMetadata=function Gd(e,t){var n=function r(e,t){var n=zd(e);return n.set("template",function r(e){if("string"==typeof e.template){if(e.isInline)return Ut(e.template);var t=e.template,n=new Oo(t,e.templateUrl),r=new Io(n,0,0,0),i=function o(e,t){var n=t.length,r=0,i=0,o=0;do{-1!==(r=t.indexOf("\n",i))&&(i=r+1,o++)}while(-1!==r);return new Io(e,n,o,n-i)}(n,t);return Ut(t,null,new ko(r,i))}return e.template}(t)),t.isInline&&n.set("isInline",Ut(!0)),n.set("styles",qd(e.styles,Ut)),n.set("directives",function s(e){var t=0!==e.declarationListEmitMode?Qd:function(e){return e};return qd(e.directives,(function(e){var n=new no;return n.set("type",t(e.type)),n.set("selector",Ut(e.selector)),n.set("inputs",qd(e.inputs,Ut)),n.set("outputs",qd(e.outputs,Ut)),n.set("exportAs",qd(e.exportAs,Ut)),n.toLiteralMap()}))}(e)),n.set("pipes",function a(e){var t,n;if(0===e.pipes.size)return null;var r=0!==e.declarationListEmitMode?Qd:function(e){return e},s=[];try{for(var a=i(e.pipes),u=a.next();!u.done;u=a.next()){var p=o(u.value,2);s.push({key:p[0],value:r(p[1]),quoted:!0})}}catch(e){t={error:e}}finally{try{u&&!u.done&&(n=a.return)&&n.call(a)}finally{if(t)throw t.error}}return Lt(s)}(e)),n.set("viewProviders",e.viewProviders),n.set("animations",e.animations),void 0!==e.changeDetection&&n.set("changeDetection",Ot(rr.ChangeDetectionStrategy).prop(E[e.changeDetection])),e.encapsulation!==g.Emulated&&n.set("encapsulation",Ot(rr.ViewEncapsulation).prop(g[e.encapsulation])),e.interpolation!==go&&n.set("interpolation",Ft([Ut(e.interpolation.start),Ut(e.interpolation.end)])),!0===t.preserveWhitespaces&&n.set("preserveWhitespaces",Ut(!0)),n}(e,t);return{expression:Ot(rr.declareComponent).callFn([n.toLiteralMap()]),type:lc(e)}},e.compileDeclareDirectiveFromMetadata=function $d(e){var t=zd(e);return{expression:Ot(rr.declareDirective).callFn([t.toLiteralMap()]),type:_c(e)}},e.compileDeclarePipeFromMetadata=function Yd(e){var t=function n(e){var t=new no;return t.set("version",Ut("12.0.0-next.0+34.sha-9661873")),t.set("ngImport",Ot(rr.core)),t.set("type",e.internalType),t.set("name",Ut(e.pipeName)),!1===e.pure&&t.set("pure",Ut(e.pure)),t}(e);return{expression:Ot(rr.declarePipe).callFn([t.toLiteralMap()]),type:Wo(e)}},e.compileDirectiveFromMetadata=uc,e.compileFactoryFunction=so,e.compileInjectable=lo,e.compileInjector=jo,e.compileNgModule=Vo,e.compilePipeFromMetadata=qo,e.componentFactoryName=Bn,e.computeMsgId=oi,e.core=ee,e.createAotCompiler=function Jd(e,t,n){var r,i=t.translations||"",o=yd(e),s=new Mn,a=new md(e,s),u=new Lf(e,s,a),p=new ud(a,u,[],[],n);r=t.enableIvy?new ru:new Th(new ru,i,t.i18nFormat,t.missingTranslation,console);var l=new $c({defaultEncapsulation:g.Emulated,useJit:!1,missingTranslation:t.missingTranslation,preserveWhitespaces:t.preserveWhitespaces,strictInjectionParameters:t.strictInjectionParameters}),c=new Jc({get:function(t){return e.loadResource(t)}},o,r,l),h=new jp(new bp),f=new Jp,d=new sp(l,p,h,f,r,console,[]),v=new Kh(l,r,new af(p),new th(p),new cf(p),a,f,c,console,s,p,n),m=new mf(p),y=new hf(t,p);return{compiler:new zf(l,t,e,p,v,d,new xa(o),m,y,new sf(p),new Ah(p,!!t.enableIvy),new pf,a,u),reflector:p}},e.createAotUrlResolver=yd,e.createElementCssSelector=hp,e.createLoweredSymbol=function Zd(e){return"ɵ"+e}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.createOfflineCompileUrlResolver=function ev(){return new kd(".")},e.createUrlResolverWithoutPackagePrefix=function tv(){return new kd},e.debugOutputAstAsTypeScript=uf,e.devOnlyGuardedExpression=function nv(e){return xr("ngDevMode",e)},e.findNode=function rv(e,t){var n=[];return Oa(new(function(e){function i(){return null!==e&&e.apply(this,arguments)||this}return r(i,e),i.prototype.visit=function(e,r){var i=function e(t){var n=t.sourceSpan.start.offset,r=t.sourceSpan.end.offset;return t instanceof Aa&&(t.endSourceSpan?r=t.endSourceSpan.end.offset:t.children&&t.children.length&&(r=e(t.children[t.children.length-1]).end)),{start:n,end:r}}(e);if(!(i.start<=t&&t<i.end))return!0;n.push(e)},i}(Ra)),e),new ba(n,t)},e.flatten=$n,e.formattedError=nd,e.getHtmlTagDefinition=y,e.getNsPrefix=c,e.getParseErrors=function iv(e){return e[rn]||[]},e.getSafePropertyAccessString=_r,e.getUrlScheme=function ov(e){var t=Dd(e);return t&&t[Id.Scheme]||""},e.hostViewClassName=Ln,e.identifierModuleUrl=Rn,e.identifierName=kn,e.isEmptyExpression=yp,e.isFormattedError=function sv(e){return!!e.ngFormattedMessage},e.isIdentifier=Op,e.isLoweredSymbol=Wh,e.isNgContainer=u,e.isNgContent=p,e.isNgTemplate=l,e.isQuote=Dp,e.isSyntaxError=function av(e){return e[nn]},e.jsDocComment=At,e.leadingComment=function uv(e,t,n){return void 0===t&&(t=!1),void 0===n&&(n=!0),new at(e,t,n)},e.literalMap=Lt,e.makeBindingParser=Jl,e.mergeAnalyzedFiles=ed,e.mergeNsAndName=h,e.ngModuleJitUrl=er,e.parseHostBindings=bc,e.parseTemplate=$l,e.preserveWhitespacesDefault=Yc,e.publishFacade=Xc,e.r3JitTypeSourceSpan=Fo,e.removeSummaryDuplicates=mp,e.rendererTypeName=Fn,e.sanitizeIdentifier=An,e.sharedStylesheetJitUrl=Zn,e.splitClasses=lp,e.splitNsName=a,e.syntaxError=tn,e.templateJitUrl=tr,e.templateSourceUrl=Jn,e.templateVisitAll=ku,e.toTypeScript=function pv(e,t){if(void 0===t&&(t=""),!e.stmts)throw new Error("Illegal state: No stmts present on GeneratedFile "+e.genFileUrl);return(new pf).emitStatements(e.genFileUrl,e.stmts,t)},e.tokenName=Vn,e.tokenReference=jn,e.typeSourceSpan=Do,e.unescapeIdentifier=Bf,e.unwrapResolvedMetadata=Vf,e.verifyHostBindings=Tc,e.viewClassName=Dn,e.visitAll=Oa,Object.defineProperty(e,"__esModule",{value:!0})}));