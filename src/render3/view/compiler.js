...
(function (factory) {
    ...
    function createHostBindingsFunction(hostBindingsMetadata, typeSourceSpan, bindingParser, constantPool, selector, name) {
        ...
        if (hostInstruction && hostInstruction.calls.length > 0) {
            createStatements.push(util_3.chainedInstruction(hostInstruction.reference, hostInstruction.calls.map(function (call) { return convertStylingCall(call, bindingContext, bindingFn); }))
                .toStmt());
        }
