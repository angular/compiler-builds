                    ...
                    if (value_2 !== undefined) {
                        ...
                        if (inputType === 0 /* Property */) {
                            ...
                            if (inputType === 2 /* Class */) {
                                instruction_2 = r3_identifiers_1.Identifiers.elementClassProp;
                            }
                            else {
