        ...
        TemplateDefinitionBuilder.prototype.i18nEnd = function (span, selfClosing) {
            ...
            if (bindings.size) {
                bindings.forEach(function (binding) {
                    _this.updateInstruction(span, r3_identifiers_1.Identifiers.i18nExp, function () { return [_this.convertPropertyBinding(o.variable(util_4.CONTEXT_NAME), binding)]; });
                });
