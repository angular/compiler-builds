...
(function (factory) {
    ...
    var TemplateDefinitionBuilder = /** @class */ (function () {
        ...
        TemplateDefinitionBuilder.prototype.i18nTranslate = function (message, params, ref, transformFn) {
            ...
            var statements = util_3.getTranslationDeclStmts(_ref, closureVar, content, meta, formattedParams, transformFn);
        ...
        TemplateDefinitionBuilder.prototype.i18nFormatPlaceholderNames = function (params, useCamelCase) {
            ...
            if (params && Object.keys(params).length) {
                Object.keys(params).forEach(function (key) { return _params[util_3.formatI18nPlaceholderName(key, useCamelCase)] = params[key]; });
            }
            return _params;
        };
