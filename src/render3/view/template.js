...
(function (factory) {
                    ...
                    if (value_2 !== undefined) {
                        ...
                        if (inputType === 0 /* Property */) {
                            if (value_2 instanceof ast_1.Interpolation) {
                                ...
                                var currValExpr = expression_converter_1.convertPropertyBinding(_this, implicit, value_2, _this.bindingContext(), expression_converter_1.BindingForm.TrySimple).currValExpr;
                                ...
                                _this.updateInstruction(elementIndex, input.sourceSpan, propertyInterpolate(args_1.length), function () {
                                    return tslib_1.__spread([o.literal(attrName_1)], args_1, params_2);
                                });
                            }
                            else {
    ...
    function propertyInterpolate(argsLength) {
        if (argsLength % 2 !== 1) {
            util_1.error("Invalid propertyInterpolate argument length " + argsLength);
        }
        switch (argsLength) {
            case 1:
