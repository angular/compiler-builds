...
(function (factory) {
    ...
    function prepareEventListenerParameters(eventAst, handlerName, scope) {
        ...
        var bindingExpr = (0, expression_converter_1.convertActionBinding)(scope, implicitReceiverExpr, handler, 'b', function () { return (0, util_1.error)('Unexpected interpolation'); }, eventAst.handlerSpan, implicitReceiverAccesses, EVENT_BINDING_SCOPE_GLOBALS);
        var statements = [];
        if (scope) {
            // `variableDeclarations` needs to run first, because
            // `restoreViewStatement` depends on the result.
            statements.push.apply(statements, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(scope.variableDeclarations()), false));
            statements.unshift.apply(statements, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(scope.restoreViewStatement()), false));
        }
        statements.push.apply(statements, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(bindingExpr.render3Stmts), false));
        var eventName = type === 1 /* Animation */ ? (0, util_2.prepareSyntheticListenerName)(name, phase) : name;
    ...
    var TemplateDefinitionBuilder = /** @class */ (function () {
        ...
        TemplateDefinitionBuilder.prototype.buildTemplateFunction = function (nodes, variables, ngContentSelectorsOffset, i18n) {
            ...
            [new o.FnParam(util_4.RENDER_FLAGS, o.NUMBER_TYPE), new o.FnParam(util_4.CONTEXT_NAME, null)], (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this._prefixCode), false), (0, tslib_1.__read)(creationBlock), false), (0, tslib_1.__read)(updateBlock), false), o.INFERRED_TYPE, null, this.templateName);
        };
        // LocalResolver
        ...
        TemplateDefinitionBuilder.prototype.i18nTranslate = function (message, params, ref, transformFn) {
            ...
            (_a = this._constants.prepareStatements).push.apply(_a, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(statements), false));
            return _ref;
        };
        ...
        TemplateDefinitionBuilder.prototype.i18nGenerateClosureVar = function (messageId) {
            ...
            if (this.i18nUseExternalIds) {
                ...
                name = "" + prefix + (0, parse_util_1.sanitizeIdentifier)(messageId) + "$$" + uniqueSuffix;
            }
            else {
                ...
                if (icus.size) {
                    icus.forEach(function (refs, key) {
                        if (refs.length === 1) {
                            ...
                            var placeholder = (0, util_3.wrapI18nPlaceholder)("" + util_3.I18N_ICU_MAPPING_PREFIX + key);
        ...
        TemplateDefinitionBuilder.prototype.interpolatedUpdateInstruction = function (instruction, elementIndex, attrName, input, value, params) {
            var _this = this;
            this.updateInstructionWithAdvance(elementIndex, input.sourceSpan, instruction, function () { return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([o.literal(attrName)], (0, tslib_1.__read)(_this.getUpdateInstructionArguments(value)), false), (0, tslib_1.__read)(params), false); });
        };
        ...
        TemplateDefinitionBuilder.prototype.visitElement = function (element) {
            ...
            var outputAttrs = [];
            var _d = (0, tslib_1.__read)((0, tags_1.splitNsName)(element.name), 2), namespaceKey = _d[0], elementName = _d[1];
            var isNgContainer = (0, tags_1.isNgContainer)(element.name);
            try {
                // Handle styling, i18n, ngNonBindable attributes
                for (var _e = (0, tslib_1.__values)(element.attributes), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var attr = _f.value;
            ...
            allOtherInputs.forEach(function (input) {
                ...
                if (inputType === 4 /* Animation */) {
                    ...
                    propertyBindings.push({
                        name: (0, util_2.prepareSyntheticPropertyName)(input.name),
                    ...
                    if (value_2 !== undefined) {
                        var params_2 = [];
                        var _a = (0, tslib_1.__read)((0, tags_1.splitNsName)(input.name), 2), attrNamespace = _a[0], attrName_1 = _a[1];
                        ...
                        if (inputType === 0 /* Property */) {
                            ...
                            _this.updateInstructionWithAdvance(elementIndex, input.sourceSpan, r3_identifiers_1.Identifiers.classProp, function () {
                                ...
                                ], (0, tslib_1.__read)(params_2), false);
                            });
                        }
                    }
                }
        ...
        TemplateDefinitionBuilder.prototype.visitTemplate = function (template) {
            ...
            var contextName = "" + this.contextName + (template.tagName ? '_' + (0, parse_util_1.sanitizeIdentifier)(template.tagName) : '') + "_" + templateIndex;
            ...
            this._nestedTemplateFns.push(function () {
                ...
                if (templateVisitor._ngContentReservedSlots.length) {
                    (_a = _this._ngContentReservedSlots).push.apply(_a, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(templateVisitor._ngContentReservedSlots), false));
                }
            });
            ...
            if (tagNameWithoutNamespace === NG_TEMPLATE_TAG_NAME) {
                var _b = (0, tslib_1.__read)((0, util_1.partitionArray)(template.inputs, util_3.hasI18nMeta), 2), i18nInputs = _b[0], inputs = _b[1];
        ...
        TemplateDefinitionBuilder.prototype.visitIcu = function (icu) {
            ...
            var transformFn = function (raw) {
                var params = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, vars), placeholders);
                var formatted = (0, util_3.i18nFormatPlaceholderNames)(params, /* useCamelCase */ false);
                return instruction(null, r3_identifiers_1.Identifiers.i18nPostprocess, [raw, (0, map_util_1.mapLiteral)(formatted, true)]);
            };
        ...
        TemplateDefinitionBuilder.prototype.creationInstructionChain = function (reference, calls) {
            ...
            this._creationCodeFns.push(function () {
                return (0, util_4.chainedInstruction)(reference, calls.map(function (call) { return call.params(); }), span).toStmt();
            });
        };
        ...
        TemplateDefinitionBuilder.prototype.updateInstructionChain = function (reference, bindings) {
            ...
            this._updateCodeFns.push(function () {
                var calls = bindings.map(function (property) {
                    ...
                    if (property.params) {
                        fnParams.push.apply(fnParams, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(property.params), false));
                    }
                    if (property.name) {
                ...
                return (0, util_4.chainedInstruction)(reference, calls, span).toStmt();
            });
        };
        ...
        TemplateDefinitionBuilder.prototype.convertPropertyBinding = function (value) {
            var _a;
            var convertedPropertyBinding = (0, expression_converter_1.convertPropertyBinding)(this, this.getImplicitReceiverExpr(), value, this.bindingContext(), expression_converter_1.BindingForm.Expression, function () { return (0, util_1.error)('Unexpected interpolation'); });
            var valExpr = convertedPropertyBinding.currValExpr;
            (_a = this._tempVariables).push.apply(_a, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(convertedPropertyBinding.stmts), false));
            return valExpr;
        };
        /**
        ...
        TemplateDefinitionBuilder.prototype.getUpdateInstructionArguments = function (value) {
            ...
            (_a = this._tempVariables).push.apply(_a, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(stmts), false));
            return args;
        };
        TemplateDefinitionBuilder.prototype.matchDirectives = function (elementName, elOrTpl) {
            var _this = this;
            if (this.directiveMatcher) {
                var selector = createCssSelector(elementName, (0, util_4.getAttrsForDirectiveMatching)(elOrTpl));
        ...
        TemplateDefinitionBuilder.prototype.getAttributeExpressions = function (elementName, renderAttributes, inputs, outputs, styles, templateAttrs, boundI18nAttrs) {
            ...
            var ngProjectAsAttr;
            try {
                for (var renderAttributes_1 = (0, tslib_1.__values)(renderAttributes), renderAttributes_1_1 = renderAttributes_1.next(); !renderAttributes_1_1.done; renderAttributes_1_1 = renderAttributes_1.next()) {
                    ...
                    if (attr.i18n) {
                        ...
                        attrExprs.push.apply(attrExprs, (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(getAttributeNameLiterals(attr.name)), false), [trustedConstAttribute(elementName, attr)], false));
                    }
                }
            }
            ...
            if (ngProjectAsAttr) {
                attrExprs.push.apply(attrExprs, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(getNgProjectAsLiteral(ngProjectAsAttr)), false));
            }
            function addAttrExpr(key, value) {
                if (typeof key === 'string') {
                    if (!alreadySeen.has(key)) {
                        attrExprs.push.apply(attrExprs, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(getAttributeNameLiterals(key)), false));
        ...
        TemplateDefinitionBuilder.prototype.prepareRefsArray = function (references) {
            ...
            var refsParam = (0, compile_metadata_1.flatten)(references.map(function (reference) {
    ...
    var ValueConverter = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ValueConverter, _super);
        ...
        ValueConverter.prototype.visitPipe = function (pipe, context) {
            ...
            var args = (0, tslib_1.__spreadArray)([pipe.exp], (0, tslib_1.__read)(pipe.args), false);
            var convertedArgs = isVarLength ?
                this.visitAll([new ast_1.LiteralArray(pipe.span, pipe.sourceSpan, args)]) :
                this.visitAll(args);
            var pipeBindExpr = new ast_1.Call(pipe.span, pipe.sourceSpan, target, (0, tslib_1.__spreadArray)([
            ...
            ], (0, tslib_1.__read)(convertedArgs), false), null);
    ...
    function getLiteralFactory(constantPool, literal, allocateSlots) {
        ...
        if (isVarLength) {
            ...
            args.push.apply(args, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(literalFactoryArguments), false));
        }
    ...
    function getAttributeNameLiterals(name) {
        var _a = (0, tslib_1.__read)((0, tags_1.splitNsName)(name), 2), attributeNamespace = _a[0], attributeName = _a[1];
    ...
    var BindingScope = /** @class */ (function () {
        function BindingScope(bindingLevel, parent, globals) {
            ...
            if (globals !== undefined) {
                try {
                    for (var globals_1 = (0, tslib_1.__values)(globals), globals_1_1 = globals_1.next(); !globals_1_1.done; globals_1_1 = globals_1.next()) {
        ...
        BindingScope.prototype.set = function (retrievalLevel, name, lhs, priority, declareLocalCallback, localRef) {
            ...
            if (this.map.has(name)) {
                ...
                (0, util_1.error)("The name " + name + " is already defined in scope to be " + this.map.get(name));
            }
            this.map.set(name, {
    ...
    function getNgProjectAsLiteral(attribute) {
        ...
        return [o.literal(5 /* ProjectAs */), (0, util_4.asLiteral)(parsedR3Selector)];
    }
    /**
    ...
    function parseTemplate(template, templateUrl, options) {
        ...
        var parseResult = htmlParser.parse(template, templateUrl, (0, tslib_1.__assign)((0, tslib_1.__assign)({ leadingTriviaChars: exports.LEADING_TRIVIA_CHARS }, options), { tokenizeExpansionForms: true }));
        ...
        var _a = (0, r3_template_transform_1.htmlAstToRender3Ast)(rootNodes, bindingParser, { collectCommentNodes: !!options.collectCommentNodes }), nodes = _a.nodes, errors = _a.errors, styleUrls = _a.styleUrls, styles = _a.styles, ngContentSelectors = _a.ngContentSelectors, commentNodes = _a.commentNodes;
        errors.push.apply(errors, (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(parseResult.errors), false), (0, tslib_1.__read)(i18nMetaResult.errors), false));
        var parsedTemplate = {
            interpolationConfig: interpolationConfig,
            preserveWhitespaces: preserveWhitespaces,
    ...
    function getTranslationDeclStmts(message, variable, closureVar, params, transformFn) {
        ...
        var statements = [
            ...
            o.ifStmt(createClosureModeGuard(), (0, get_msg_utils_1.createGoogleGetMsgStatements)(variable, message, closureVar, (0, util_3.i18nFormatPlaceholderNames)(params, /* useCamelCase */ true)), (0, localize_utils_1.createLocalizeStatements)(variable, message, (0, util_3.i18nFormatPlaceholderNames)(params, /* useCamelCase */ false))),
        ];
        if (transformFn) {
