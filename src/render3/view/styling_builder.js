(function (factory) {
    ...
    var StylingBuilder = /** @class */ (function () {
        ...
        StylingBuilder.prototype.registerStyleInput = function (name, isMapBased, value, sourceSpan, suffix) {
            if ((0, template_parser_1.isEmptyExpression)(value)) {
                return null;
            }
                ...
                var call = {
                    ...
                    params: function (convertFn) {
                        ...
                        if (Array.isArray(convertResult)) {
                            params.push.apply(params, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(convertResult), false));
                        }
                        else {
        ...
        StylingBuilder.prototype.buildUpdateLevelInstructions = function (valueConverter) {
            ...
            if (this.hasBindings) {
                ...
                instructions.push.apply(instructions, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this._buildStyleInputs(valueConverter)), false));
                instructions.push.apply(instructions, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this._buildClassInputs(valueConverter)), false));
            }
            return instructions;
        };
