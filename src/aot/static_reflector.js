...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define("@angular/compiler/src/aot/static_reflector", ["require", "exports", "tslib", "@angular/compiler/src/compile_metadata", "@angular/compiler/src/core", "@angular/compiler/src/parse_util", "@angular/compiler/src/aot/formatted_error", "@angular/compiler/src/aot/static_symbol"], factory);
    }
    ...
    var StaticReflector = /** @class */ (function () {
        ...
        StaticReflector.prototype.invalidateSymbols = function (symbols) {
            var e_1, _a;
            try {
                for (var symbols_1 = (0, tslib_1.__values)(symbols), symbols_1_1 = symbols_1.next(); !symbols_1_1.done; symbols_1_1 = symbols_1.next()) {
        ...
        StaticReflector.prototype._annotations = function (type, simplify, annotationCache) {
            ...
            if (!annotations) {
                ...
                if (parentType) {
                    ...
                    annotations.push.apply(annotations, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(parentAnnotations), false));
                }
                var ownAnnotations_1 = [];
                if (classMetadata['decorators']) {
                    ownAnnotations_1 = simplify(type, classMetadata['decorators']);
                    if (ownAnnotations_1) {
                        annotations.push.apply(annotations, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(ownAnnotations_1), false));
                    }
                }
            ...
            if (!propMetadata) {
                ...
                Object.keys(members_1).forEach(function (propName) {
                    ...
                    if (propMetadata === null || propMetadata === void 0 ? void 0 : propMetadata.hasOwnProperty(propName)) {
                        decorators.push.apply(decorators, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(propMetadata[propName]), false));
                    }
                    propMetadata[propName] = decorators;
                    if (prop && prop['decorators']) {
                        decorators.push.apply(decorators, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(_this.simplify(type, prop['decorators'])), false));
                    }
                });
                ...
                if (!parameters_1) {
                    ...
                    if (ctorData) {
                        ...
                        rawParameterTypes.forEach(function (rawParamType, index) {
                            ...
                            if (decorators) {
                                nestedResult.push.apply(nestedResult, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(decorators), false));
                            }
        ...
        StaticReflector.prototype.guards = function (type) {
            ...
            var result = {};
            try {
                for (var staticMembers_1 = (0, tslib_1.__values)(staticMembers), staticMembers_1_1 = staticMembers_1.next(); !staticMembers_1_1.done; staticMembers_1_1 = staticMembers_1.next()) {
        ...
        StaticReflector.prototype._registerDecoratorOrConstructor = function (type, ctor) {
            this.conversionMap.set(type, function (context, args) { return new (ctor.bind.apply(ctor, (0, tslib_1.__spreadArray)([void 0], (0, tslib_1.__read)(args), false)))(); });
        };
            ...
            function simplifyInContext(context, value, depth, references) {
                        ...
                        try {
                            ...
                            if (value_1 && (depth != 0 || value_1.__symbolic != 'error')) {
                                ...
                                if (defaults && defaults.length > args.length) {
                                    args.push.apply(args, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(defaults.slice(args.length).map(function (value) { return simplify(value); })), false));
                                }
                ...
                function simplify(expression) {
                    ...
                    if (Array.isArray(expression)) {
                        var result_2 = [];
                        try {
                            for (var _c = (0, tslib_1.__values)(expression), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var item = _d.value;
                                ...
                                if (item && item.__symbolic === 'spread') {
                                    ...
                                    if (Array.isArray(spreadArray)) {
                                        try {
                                            for (var spreadArray_1 = (e_4 = void 0, (0, tslib_1.__values)(spreadArray)), spreadArray_1_1 = spreadArray_1.next(); !spreadArray_1_1.done; spreadArray_1_1 = spreadArray_1.next()) {
    ...
    var PopulatedScope = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(PopulatedScope, _super);
