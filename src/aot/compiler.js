...
(function (factory) {
    ...
    var AotCompiler = /** @class */ (function () {
        ...
        AotCompiler.prototype.listLazyRoutes = function (entryRoute, analyzedModules) {
            ...
            var self = this;
            if (entryRoute) {
                var symbol = (0, lazy_routes_1.parseLazyRoute)(entryRoute, this.reflector).referencedModule;
                return visitLazyRoute(symbol);
            }
            else if (analyzedModules) {
                var allLazyRoutes = [];
                try {
                    for (var _c = (0, tslib_1.__values)(analyzedModules.ngModules), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var ngModule = _d.value;
                        var lazyRoutes = (0, lazy_routes_1.listLazyRoutes)(ngModule, this.reflector);
                        try {
                            for (var lazyRoutes_1 = (e_3 = void 0, (0, tslib_1.__values)(lazyRoutes)), lazyRoutes_1_1 = lazyRoutes_1.next(); !lazyRoutes_1_1.done; lazyRoutes_1_1 = lazyRoutes_1.next()) {
            ...
            function visitLazyRoute(symbol, seenRoutes, allLazyRoutes) {
                ...
                var lazyRoutes = (0, lazy_routes_1.listLazyRoutes)(self._metadataResolver.getNgModuleMetadata(symbol, true), self.reflector);
                try {
                    for (var lazyRoutes_2 = (0, tslib_1.__values)(lazyRoutes), lazyRoutes_2_1 = lazyRoutes_2.next(); !lazyRoutes_2_1.done; lazyRoutes_2_1 = lazyRoutes_2.next()) {
