...
(function (factory) {
    ...
    var StaticSymbolResolver = /** @class */ (function () {
        ...
        StaticSymbolResolver.prototype.getImportAs = function (staticSymbol, useSummaries) {
            ...
            var summarizedFileName = (0, util_2.stripSummaryForJitFileSuffix)(staticSymbol.filePath);
            if (summarizedFileName !== staticSymbol.filePath) {
                var summarizedName = (0, util_2.stripSummaryForJitNameSuffix)(staticSymbol.name);
                var baseSymbol = this.getStaticSymbol(summarizedFileName, summarizedName, staticSymbol.members);
                var baseImportAs = this.getImportAs(baseSymbol, useSummaries);
                return baseImportAs ? this.getStaticSymbol((0, util_2.summaryForJitFileName)(baseImportAs.filePath), (0, util_2.summaryForJitName)(baseImportAs.name), baseSymbol.members) :
                    null;
            }
        ...
        StaticSymbolResolver.prototype.getTypeArity = function (staticSymbol) {
            ...
            // generating code.
            if ((0, util_2.isGeneratedFile)(staticSymbol.filePath)) {
                return null;
            }
        ...
        StaticSymbolResolver.prototype._createSymbolsOf = function (filePath) {
            ...
            if (metadata['exports']) {
                ...
                var this_1 = this;
                try {
                    for (var _c = (0, tslib_1.__values)(metadata['exports']), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            try {
                for (var resolvedSymbols_1 = (0, tslib_1.__values)(resolvedSymbols), resolvedSymbols_1_1 = resolvedSymbols_1.next(); !resolvedSymbols_1_1.done; resolvedSymbols_1_1 = resolvedSymbols_1.next()) {
        ...
        StaticSymbolResolver.prototype.createResolvedSymbol = function (sourceSymbol, topLevelPath, topLevelSymbolNames, metadata) {
            ...
            var ReferenceTransformer = /** @class */ (function (_super) {
                (0, tslib_1.__extends)(ReferenceTransformer, _super);
                ...
                ReferenceTransformer.prototype.visitStringMap = function (map, functionParams) {
                    ...
                    if (symbolic === 'function') {
                        ...
                        functionParams.push.apply(functionParams, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)((map['parameters'] || [])), false));
                        ...
                        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, map), { fileName: getOriginalName() });
                    }
                    else {
            ...
            var transformedMeta = (0, util_1.visitValue)(metadata, new ReferenceTransformer(), []);
