(function (factory) {
    ...
    function createSummaryForJitFunction(outputCtx, reference, value) {
        var fnName = (0, util_2.summaryForJitName)(reference.name);
    ...
    var ToJsonSerializer = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ToJsonSerializer, _super);
        ...
        ToJsonSerializer.prototype.addSummary = function (summary) {
            ...
            if (!unprocessedSummary.metadata && summary.metadata) {
                ...
                if (metadata_1 instanceof static_symbol_1.StaticSymbol &&
                    ...
                    if (!(0, util_2.isLoweredSymbol)(declarationSymbol.name)) {
        ...
        ToJsonSerializer.prototype.processValue = function (value, flags) {
            return (0, util_1.visitValue)(value, this, flags);
        };
        ...
        ToJsonSerializer.prototype.visitStringMap = function (map, context) {
            if (map['__symbolic'] === 'resolved') {
                return (0, util_1.visitValue)(map['symbol'], this, context);
            }
    ...
    var ForJitSerializer = /** @class */ (function () {
        ...
        ForJitSerializer.prototype.serialize = function (exportAsArr) {
            ...
            try {
                for (var exportAsArr_1 = (0, tslib_1.__values)(exportAsArr), exportAsArr_1_1 = exportAsArr_1.next(); !exportAsArr_1_1.done; exportAsArr_1_1 = exportAsArr_1.next()) {
            ...
            try {
                for (var _e = (0, tslib_1.__values)(this.data), _f = _e.next(); !_f.done; _f = _e.next()) {
                    ...
                    if (summary.summaryKind === compile_metadata_1.CompileSummaryKind.NgModule) {
                        ...
                        try {
                            for (var _h = (e_3 = void 0, (0, tslib_1.__values)(modSummary.modules)), _j = _h.next(); !_j.done; _j = _h.next()) {
                                var mod = _j.value;
                    ...
                    if (!isLibrary) {
                        var fnName = (0, util_2.summaryForJitName)(summary.type.reference.name);
            ...
            ngModuleSymbols.forEach(function (ngModuleSymbol) {
                if (_this.summaryResolver.isLibraryFile(ngModuleSymbol.filePath)) {
                    ...
                    var jitExportAsName = (0, util_2.summaryForJitName)(exportAs);
        ...
        ForJitSerializer.prototype.serializeSummaryWithDeps = function (summary, metadata) {
            ...
            if (metadata instanceof compile_metadata_1.CompileNgModuleMetadata) {
                expressions.push.apply(expressions, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(
                ...
                metadata.declaredDirectives.concat(metadata.declaredPipes)
                    ...
                    .map(function (ref) { return _this.serializeSummaryRef(ref); })), false));
            ...
            expressions.push.apply(expressions, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(providers.filter(function (provider) { return !!provider.useClass; }).map(function (provider) { return _this.serializeSummary({
        ...
        ForJitSerializer.prototype.serializeSummaryRef = function (typeSymbol) {
            var jitImportedSymbol = this.symbolResolver.getStaticSymbol((0, util_2.summaryForJitFileName)(typeSymbol.filePath), (0, util_2.summaryForJitName)(typeSymbol.name));
        ...
        ForJitSerializer.prototype.serializeSummary = function (data) {
            ...
            var Transformer = /** @class */ (function () {
                ...
                Transformer.prototype.visitArray = function (arr, context) {
                    var _this = this;
                    return o.literalArr(arr.map(function (entry) { return (0, util_1.visitValue)(entry, _this, context); }));
                };
                Transformer.prototype.visitStringMap = function (map, context) {
                    var _this = this;
                    return new o.LiteralMapExpr(Object.keys(map).map(function (key) { return new o.LiteralMapEntry(key, (0, util_1.visitValue)(map[key], _this, context), false); }));
                };
            ...
            return (0, util_1.visitValue)(data, new Transformer(), null);
        };
        return ForJitSerializer;
    }());
    var FromJsonDeserializer = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(FromJsonDeserializer, _super);
        ...
        FromJsonDeserializer.prototype.deserialize = function (libraryFileName, json) {
            ...
            data.symbols.forEach(function (serializedSymbol, index) {
                ...
                if (typeof importAs === 'number') {
                    ...
                    allImportAs.push({ symbol: symbol, importAs: _this.symbolCache.get((0, util_2.ngfactoryFilePath)(libraryFileName), importAs) });
                }
            });
            var summaries = (0, util_1.visitValue)(data.summaries, this, null);
