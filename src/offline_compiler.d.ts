...
export declare function analyzeNgModules(ngModules: StaticSymbol[], metadataResolver: CompileMetadataResolver): {
...
export declare class OfflineCompiler {
    ...
    private _compileSrcFile(srcFileUrl, ngModuleByDirective, directives, ngModules);
