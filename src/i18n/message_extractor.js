...
var MessageExtractor = (function () {
    ...
    MessageExtractor.prototype._extractMessagesFromAttributes = function (p) {
        ...
        p.attrs.forEach(function (attr) {
            if (attr.name.startsWith(shared_1.I18N_ATTR_PREFIX)) {
                try {
                    ...
                    _this.messages.push(shared_1.messageFromI18nAttribute(_this._parser, p, attr));
                }
                catch (e) {
        ...
        p.attrs.filter(function (attr) { return !attr.name.startsWith(shared_1.I18N_ATTR_PREFIX); })
            ...
            .forEach(function (attr) { return _this.messages.push(shared_1.messageFromAttribute(_this._parser, attr)); });
    };
