...
(function (factory) {
    ...
    function partitionArray(arr, conditionFn) {
        ...
        var falsy = [];
        try {
            for (var arr_1 = (0, tslib_1.__values)(arr), arr_1_1 = arr_1.next(); !arr_1_1.done; arr_1_1 = arr_1.next()) {
