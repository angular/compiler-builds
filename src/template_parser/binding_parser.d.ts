...
export declare class BindingParser {
    ...
    constructor(_exprParser: Parser, _interpolationConfig: InterpolationConfig, _schemaRegistry: ElementSchemaRegistry, _schemas: SchemaMetadata[], pipes: CompilePipeMetadata[], _targetErrors: ParseError[]);
    createDirectiveHostPropertyAsts(elementName: string, hostProps: {
        [key: string]: string;
    }, sourceSpan: ParseSourceSpan): BoundElementPropertyAst[];
    createDirectiveHostEventAsts(hostListeners: {
        [key: string]: string;
    }, sourceSpan: ParseSourceSpan): BoundEventAst[];
