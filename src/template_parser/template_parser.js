...
import { AttrAst, BoundDirectivePropertyAst, BoundTextAst, DirectiveAst, ElementAst, EmbeddedTemplateAst, NgContentAst, ReferenceAst, TextAst, VariableAst, templateVisitAll } from './template_ast';
...
export var TemplateParser = (function () {
    ...
    TemplateParser.prototype.tryParseHtml = function (htmlAstWithErrors, component, template, directives, pipes, schemas, templateUrl) {
        ...
        if (htmlAstWithErrors.rootNodes.length > 0) {
            ...
            var bindingParser = new BindingParser(this._exprParser, interpolationConfig, this._schemaRegistry, schemas, uniqPipes, errors);
...
var TemplateParseVisitor = (function () {
    ...
    TemplateParseVisitor.prototype._createDirectiveAsts = function (isTemplateElement, elementName, directives, props, elementOrDirectiveRefs, elementSourceSpan, targetReferences) {
        ...
        var directiveAsts = directives.map(function (directive) {
            ...
            var hostProperties = _this._bindingParser.createDirectiveHostPropertyAsts(elementName, directive.hostProperties, sourceSpan);
            var hostEvents = _this._bindingParser.createDirectiveHostEventAsts(directive.hostListeners, sourceSpan);
