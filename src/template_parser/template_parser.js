...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define("@angular/compiler/src/template_parser/template_parser", ["require", "exports", "tslib", "@angular/compiler/src/expression_parser/ast", "@angular/compiler/src/identifiers", "@angular/compiler/src/ml_parser/ast", "@angular/compiler/src/ml_parser/html_parser", "@angular/compiler/src/ml_parser/html_whitespaces", "@angular/compiler/src/ml_parser/icu_ast_expander", "@angular/compiler/src/ml_parser/interpolation_config", "@angular/compiler/src/ml_parser/tags", "@angular/compiler/src/parse_util", "@angular/compiler/src/provider_analyzer", "@angular/compiler/src/selector", "@angular/compiler/src/style_url_resolver", "@angular/compiler/src/util", "@angular/compiler/src/template_parser/binding_parser", "@angular/compiler/src/template_parser/template_ast", "@angular/compiler/src/template_parser/template_preparser"], factory);
    }
    ...
    var TemplateParseError = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(TemplateParseError, _super);
    ...
    var TemplateParser = /** @class */ (function () {
        ...
        TemplateParser.prototype.parse = function (component, template, directives, pipes, schemas, templateUrl, preserveWhitespaces) {
            ...
            if (errors.length > 0) {
                ...
                throw (0, parse_util_1.syntaxError)("Template parse errors:\n" + errorString, errors);
            }
        ...
        TemplateParser.prototype.tryParse = function (component, template, directives, pipes, schemas, templateUrl, preserveWhitespaces) {
            ...
            if (!preserveWhitespaces) {
                htmlParseResult = (0, html_whitespaces_1.removeWhitespaces)(htmlParseResult);
            }
        ...
        TemplateParser.prototype.tryParseHtml = function (htmlAstWithErrors, component, directives, pipes, schemas) {
            ...
            if (htmlAstWithErrors.rootNodes.length > 0) {
                ...
                errors.push.apply(errors, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(providerViewContext.errors), false));
                usedPipes.push.apply(usedPipes, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(bindingParser.getUsedPipes()), false));
            }
            else {
                result = [];
            }
        ...
        TemplateParser.prototype.expandHtml = function (htmlAstWithErrors, forced) {
            ...
            if (errors.length == 0 || forced) {
                ...
                var expandedHtmlAst = (0, icu_ast_expander_1.expandNodes)(htmlAstWithErrors.rootNodes);
                errors.push.apply(errors, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(expandedHtmlAst.errors), false));
    ...
    var TemplateParseVisitor = /** @class */ (function () {
        ...
        TemplateParseVisitor.prototype.visitText = function (text, parent) {
            ...
            var valueNoNgsp = (0, html_whitespaces_1.replaceNgsp)(text.value);
        ...
        TemplateParseVisitor.prototype.visitElement = function (element, parent) {
            ...
            element.attrs.forEach(function (attr) {
                ...
                elementVars.push.apply(elementVars, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(parsedVariables.map(function (v) { return t.VariableAst.fromParsedVariable(v); })), false));
                var templateValue;
                var templateKey;
                ...
                if (hasTemplateBinding) {
                    ...
                    templateElementVars.push.apply(templateElementVars, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(parsedVariables_1.map(function (v) { return t.VariableAst.fromParsedVariable(v); })), false));
                }
        ...
        TemplateParseVisitor.prototype._parseAttr = function (isTemplateElement, attr, targetMatchableAttrs, targetProps, targetEvents, targetRefs, targetVars) {
            ...
            targetEvents.push.apply(targetEvents, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(boundEvents.map(function (e) { return t.BoundEventAst.fromParsedEvent(e); })), false));
            return hasBinding;
        };
        ...
        TemplateParseVisitor.prototype._parseDirectives = function (selectorMatcher, elementCssSelector) {
            ...
            var directives = (0, util_1.newArray)(this.directivesIndex.size);
        ...
        TemplateParseVisitor.prototype._createDirectiveAsts = function (isTemplateElement, elementName, directives, props, elementOrDirectiveRefs, elementSourceSpan, targetReferences, targetBoundDirectivePropNames) {
            ...
            var directiveAsts = directives.map(function (directive) {
                var sourceSpan = new parse_util_1.ParseSourceSpan(elementSourceSpan.start, elementSourceSpan.end, elementSourceSpan.fullStart, "Directive " + (0, parse_util_1.identifierName)(directive.type));
                ...
                elementOrDirectiveRefs.forEach(function (elOrDirRef) {
                    if ((elOrDirRef.value.length === 0 && directive.isComponent) ||
                        ...
                        targetReferences.push(new t.ReferenceAst(elOrDirRef.name, (0, identifiers_1.createTokenForReference)(directive.type.reference), elOrDirRef.value, elOrDirRef.sourceSpan));
            ...
            elementOrDirectiveRefs.forEach(function (elOrDirRef) {
                if (elOrDirRef.value.length > 0) {
                    ...
                    var refToken = null;
                    if (isTemplateElement) {
                        refToken = (0, identifiers_1.createTokenForExternalReference)(_this.reflector, identifiers_1.Identifiers.TemplateRef);
                    }
        ...
        TemplateParseVisitor.prototype._findComponentDirectiveNames = function (directives) {
            return this._findComponentDirectives(directives)
                .map(function (directive) { return (0, parse_util_1.identifierName)(directive.directive.type); });
        };
    ...
    function createElementCssSelector(elementName, attributes) {
        ...
        var elNameNoNs = (0, tags_1.splitNsName)(elementName)[1];
        cssSelector.setElement(elNameNoNs);
        for (var i = 0; i < attributes.length; i++) {
            var attrName = attributes[i][0];
            var attrNameNoNs = (0, tags_1.splitNsName)(attrName)[1];
