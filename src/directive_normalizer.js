...
(function (factory) {
    ...
    var DirectiveNormalizer = /** @class */ (function () {
        ...
        DirectiveNormalizer.prototype.normalizeTemplate = function (prenormData) {
            var _this = this;
            if ((0, util_1.isDefined)(prenormData.template)) {
                if ((0, util_1.isDefined)(prenormData.templateUrl)) {
                    throw (0, parse_util_1.syntaxError)("'" + (0, util_1.stringify)(prenormData
                        .componentType) + "' component cannot define both template and templateUrl");
                }
                if (typeof prenormData.template !== 'string') {
                    throw (0, parse_util_1.syntaxError)("The template specified for component " + (0, util_1.stringify)(prenormData.componentType) + " is not a string");
                }
            }
            else if ((0, util_1.isDefined)(prenormData.templateUrl)) {
                if (typeof prenormData.templateUrl !== 'string') {
                    throw (0, parse_util_1.syntaxError)("The templateUrl specified for component " + (0, util_1.stringify)(prenormData.componentType) + " is not a string");
                }
            }
            else {
                throw (0, parse_util_1.syntaxError)("No template specified for component " + (0, util_1.stringify)(prenormData.componentType));
            }
            if ((0, util_1.isDefined)(prenormData.preserveWhitespaces) &&
                typeof prenormData.preserveWhitespaces !== 'boolean') {
                throw (0, parse_util_1.syntaxError)("The preserveWhitespaces option for component " + (0, util_1.stringify)(prenormData.componentType) + " must be a boolean");
            }
        ...
        DirectiveNormalizer.prototype._preparseLoadedTemplate = function (prenormData, template, templateAbsUrl) {
            ...
            var templateUrl = (0, compile_metadata_1.templateSourceUrl)({ reference: prenormData.ngModuleType }, { type: { reference: prenormData.componentType } }, { isInline: isInline, templateUrl: templateAbsUrl });
        ...
        DirectiveNormalizer.prototype._normalizeLoadedTemplateMetadata = function (prenormData, preparsedTemplate, stylesheets) {
            ...
            var _this = this;
            var styles = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(preparsedTemplate.styles), false);
            ...
            var externalStylesheets = styleUrls.map(function (styleUrl) {
                ...
                var styles = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(stylesheet.styles), false);
            ...
            return new compile_metadata_1.CompileTemplateMetadata({
                ...
                preserveWhitespaces: (0, config_1.preserveWhitespacesDefault)(prenormData.preserveWhitespaces, this._config.preserveWhitespaces),
            });
        };
        ...
        DirectiveNormalizer.prototype._normalizeStylesheet = function (stylesheet) {
            ...
            var allStyles = stylesheet.styles.map(function (style) {
                var styleWithImports = (0, style_url_resolver_1.extractStyleUrls)(_this._urlResolver, moduleUrl, style);
                allStyleUrls.push.apply(allStyleUrls, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(styleWithImports.styleUrls), false));
