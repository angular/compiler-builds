...
export class TemplateDefinitionBuilder {
    ...
    visitForLoopBlock(block) {
        ...
        this.creationInstruction(block.sourceSpan, R3.repeaterCreate, () => {
            ...
            if (emptyData !== null) {
                params.push(o.variable(emptyData.name), o.literal(emptyData.getConstCount()), o.literal(emptyData.getVarCount()));
            }
            return params;
        });
        // `repeater(0, iterable)`
    ...
    createForLoopVariables(block) {
        ...
        this._bindingScope.set(this.level, getLoopLocalName(block, '$odd'), scope => scope.get(indexLocalName).modulo(o.literal(2)).notIdentical(o.literal(0)));
        this._bindingScope.set(this.level, getLoopLocalName(block, '$even'), scope => scope.get(indexLocalName).modulo(o.literal(2)).identical(o.literal(0)));
        this._bindingScope.set(this.level, getLoopLocalName(block, '$first'), scope => scope.get(indexLocalName).identical(o.literal(0)));
        this._bindingScope.set(this.level, getLoopLocalName(block, '$last'), scope => scope.get(indexLocalName).identical(scope.get(countLocalName).minus(o.literal(1))));
        return [
    ...
    createTrackByFunction(block) {
        ...
        if (ast instanceof PropertyRead && ast.receiver instanceof PropertyRead &&
            ...
            const binding = convertPropertyBinding(scope, o.variable(CONTEXT_NAME), block.trackBy, 'trackBy');
