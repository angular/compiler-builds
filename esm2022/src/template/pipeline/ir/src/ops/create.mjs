...
import { TRAIT_CONSUMES_SLOT, TRAIT_CONSUMES_VARS, TRAIT_HAS_CONST, TRAIT_USES_SLOT_INDEX } from '../traits';
 ...
 */
export function createBindingSignalPlaceholderOp(bindingXref) {
    return {
 ...
 */
export function createPropertyCreateOp(bindingXref, target, name, expression, isAnimationTrigger, securityContext, isTemplate, sourceSpan) {
    return {
