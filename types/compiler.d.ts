...
declare class UnaryOperatorExpr extends Expression {
    ...
    parens: boolean;
    isPrefix: boolean;
    constructor(operator: UnaryOperator, expr: Expression, type?: Type$1 | null, sourceSpan?: ParseSourceSpan$1 | null, parens?: boolean, leadingComments?: LeadingComment[], isPrefix?: boolean);
    isEquivalent(e: Expression): boolean;
    isConstant(): boolean;
    visitExpression(visitor: ExpressionVisitor, context: any): any;
...
declare class LiteralMapPropertyAssignment {
    ...
    quoted: boolean;
    leadingComments?: LeadingComment[] | undefined;
    constructor(key: string, value: Expression, quoted: boolean, leadingComments?: LeadingComment[] | undefined);
...
declare class ConstantPool {
    ...
    getSharedFunctionReference(fn: Expression, prefix: string, useUniqueName?: boolean): ReadVarExpr;
    /**
...
declare class Unary extends Binary {
     ...
     */
    static createPrefixUpdate(span: ParseSpan, sourceSpan: AbsoluteSourceSpan, operator: '++' | '--', expr: AST): Unary;
    /**
     * Creates a postfix expression (e.g. `x++` or `y--`).
     */
    static createPostfixUpdate(span: ParseSpan, sourceSpan: AbsoluteSourceSpan, operator: '++' | '--', expr: AST): Unary;
    /**
 ...
 */
declare function unwrapWriteTarget(ast: AST): AST;
...
declare abstract class AbstractEmitterVisitor implements StatementVisitor, ExpressionVisitor, TypeVisitor {
    ...
    protected printLeadingComments(node: {
 ...
 */
interface R3ClassMetadataCtorParameter {
    /**
...
interface R3ClassMetadata {
     ...
     */
    ctorParameters: Expression | R3ClassMetadataCtorParameter[] | null;
    /**
