        ...
        return inputs.map(input => {
            ...
            return {
                ...
                params: (convertFn) => {
                    ...
                    const params = [o.literal(bindingIndex)];
