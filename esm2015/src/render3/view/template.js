    ...
    i18nEnd(span = null, selfClosing) {
        ...
        if (bindings.size) {
            bindings.forEach(binding => {
                this.updateInstruction(span, R3.i18nExp, () => [this.convertPropertyBinding(o.variable(CONTEXT_NAME), binding)]);
            });
