 ...
 * found in the LICENSE file at https://angular.io/license
 */
const VERSION = new Version('13.2.0-next.1+52.sha-6a55aff.with-local-changes');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', literal('13.2.0-next.1+52.sha-6a55aff.with-local-changes'));
