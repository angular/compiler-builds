 ...
 * found in the LICENSE file at https://angular.io/license
 */
const VERSION = new Version('13.2.0-next.2+16.sha-35345b6.with-local-changes');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', literal('13.2.0-next.2+16.sha-35345b6.with-local-changes'));
