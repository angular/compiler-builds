 ...
 * found in the LICENSE file at https://angular.io/license
 */
const VERSION = new Version('13.2.0-next.1+13.sha-7cb2999.with-local-changes');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', literal('13.2.0-next.1+13.sha-7cb2999.with-local-changes'));
