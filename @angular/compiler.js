...
class CompileMetadataResolver {
     ...
     * @return {?}
     */
    initComponentFactory(factory, inputs, outputs, ngContentSelectors) {
        if (!(factory instanceof StaticSymbol)) {
            ...
            for (let /** @type {?} */ propName in outputs) {
                const /** @type {?} */ templateName = outputs[propName];
    ...
    _loadDirectiveMetadata(ngModuleType, directiveType, isSync) {
        ...
        const /** @type {?} */ createDirectiveMetadata = (templateMetadata) => {
            ...
            if (templateMetadata) {
                this.initComponentFactory(metadata.componentFactory, metadata.inputs, metadata.outputs, templateMetadata.ngContentSelectors);
            }
...
class ViewBuilder {
    ...
    _createNodeExpressions() {
        ...
        const /** @type {?} */ nodeDefExprs = this.nodes.map((factory, nodeIndex) => {
            ...
            // as the value.
            const /** @type {?} */ logWithNodeDef = new CommaExpr([LOG_VAR.callFn([]).callFn([]), nodeDef]);
