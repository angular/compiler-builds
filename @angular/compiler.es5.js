 ...
 * @param {?} eventAst
 * @return {?}
 */function eventName(eventAst){return eventAst.isAnimation?'@'+eventAst.name+'.'+eventAst.phase:eventAst.name;}var AnimationEntryCompileResult=/**
     * @param {?} name
     * @param {?} statements
     * @param {?} fnExp
