                    ...
                    if (attr instanceof t.TextAttribute) {
                        ...
                        if (converted instanceof Interpolation) {
                            ...
                            converted.expressions.forEach(function (expression) {
                                hasBindings_1 = true;
                                _this.updateInstruction(elementIndex, element.sourceSpan, R3.i18nExp, function () { return [_this.convertExpressionBinding(expression)]; });
                            });
                        }
                    }
                });
                ...
                if (value_2 !== undefined) {
                    ...
                    if (inputType === 0 /* Property */) {
                        if (value_2 instanceof Interpolation) {
                            ...
                            // [prop]="value"
                            _this.boundUpdateInstruction(R3.property, elementIndex, attrName_1, input, value_2, params_2);
                        }
                    }
                        ...
                        if (value_2 instanceof Interpolation && getInterpolationArgsLength(value_2) > 1) {
                            ...
                            _this.boundUpdateInstruction(R3.attribute, elementIndex, attrName_1, input, boundValue, params_2);
                        }
                    }
                    else {
                        // class prop
