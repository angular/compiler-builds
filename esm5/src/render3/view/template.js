    ...
    TemplateDefinitionBuilder.prototype.i18nEnd = function (span, selfClosing) {
        ...
        if (bindings.size) {
            bindings.forEach(function (binding) {
                _this.updateInstruction(index, span, R3.i18nExp, function () { return [_this.convertPropertyBinding(binding, /* skipBindFn */ true)]; });
            });
                    ...
                    if (attr instanceof t.TextAttribute) {
                        ...
                        if (converted instanceof Interpolation) {
                            ...
                            converted.expressions.forEach(function (expression) {
                                hasBindings_1 = true;
                                _this.updateInstruction(elementIndex, element.sourceSpan, R3.i18nExp, function () { return [_this.convertExpressionBinding(expression, /* skipBindFn */ true)]; });
                            });
                        }
                    }
                });
        ...
        attrs.forEach(function (input) {
            if (input instanceof t.BoundAttribute) {
                ...
                if (value_4 !== undefined) {
                    ...
                    _this.updateInstruction(templateIndex, template.sourceSpan, R3.property, function () {
